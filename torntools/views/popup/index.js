...
requireDatabase(false)
    .then(() => {
        ...
        doc.find(".settings").onclick = function () {
...
function mainMarket() {
    ...
    // setup searchbar
    doc.find("#market #search-bar").addEventListener("keyup", function (event) {
    ...
    doc.find("#market #search-bar").onclick = function (event) {
        event.target.value = "";
...
function mainStocks() {
    ...
    // setup searchbar
    doc.find("#stocks #search-bar").addEventListener("keyup", function (event) {
        let keyword = event.target.value.toLowerCase();
    ...
    doc.find("#stocks #search-bar").addEventListener("click", function (event) {
        event.target.value = "";
...
function mainCalculator() {
    ...
    // setup searchbar
    doc.find("#calculator #search-bar").addEventListener("keyup", function (event) {
        let keyword = event.target.value.toLowerCase();
    ...
    doc.find("#calculator #search-bar").addEventListener("click", function (event) {
        event.target.value = "";
