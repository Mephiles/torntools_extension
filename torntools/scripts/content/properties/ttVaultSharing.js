window.addEventListener("load", async function(event) {
    ...
    async function Main(vault, theme, need_to_save){
        ...
        let vault_container = content.new_container("Vault Sharing", {id: "tt-vault-container", next_element: doc.find(".vault-wrap+hr"), theme:theme, collapsed: false}).find(".content");
