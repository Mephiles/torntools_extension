const MISSIONS = {
	...
	"Double Jeopardy": {
		...
		hint: "You cannot claim your own bounties, so may as well just put the bounty, then leave or mug. The bounty can be low because it doesn't have to be claimed.",
	},
