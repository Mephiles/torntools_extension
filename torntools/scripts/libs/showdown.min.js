...
(function () {
	...
	function r(e, r) {
		...
		for (var s = 0; s < e.length; ++s) {
			...
			if (("language" === l && (l = i.type = "lang"), "html" === l && (l = i.type = "output"), "lang" !== l && "output" !== l && "listener" !== l))
				return (n.valid = !1), (n.error = o + "type " + l + ' is not recognized. Valid values: "lang/language", "output/html" or "listener"'), n;
			if ("listener" === l) {
				if (a.helper.isUndefined(i.listeners))
					return (n.valid = !1), (n.error = o + '. Extensions of type "listener" must have a property called "listeners"'), n;
			} else if (a.helper.isUndefined(i.filter) && a.helper.isUndefined(i.regex))
				return (n.valid = !1), (n.error = o + l + ' extensions must define either a "regex" property or a "filter" method'), n;
			if (i.listeners) {
				if ("object" != typeof i.listeners)
					return (n.valid = !1), (n.error = o + '"listeners" property must be an object but ' + typeof i.listeners + " given"), n;
			...
			if (i.filter) {
				...
				if ((a.helper.isString(i.regex) && (i.regex = new RegExp(i.regex, "g")), !(i.regex instanceof RegExp)))
					return (n.valid = !1), (n.error = o + '"regex" property must either be a string or a RegExp object, but ' + typeof i.regex + " given"), n;
	...
	(a.helper.matchRecursiveRegExp = function (e, r, t, a) {
				...
				(this.makeMarkdown = this.makeMd = function (e, r) {
					function t(e) {
						for (var r = 0; r < e.childNodes.length; ++r) {
							...
							3 === a.nodeType
								? /\S/.test(a.nodeValue)
									? ((a.nodeValue = a.nodeValue.split("\n").join(" ")), (a.nodeValue = a.nodeValue.replace(/(\s)+/g, "$1")))
									: (e.removeChild(a), --r)
								: 1 === a.nodeType && t(a);
						}
					}
		...
		a.subParser("anchors", function (e, r, t) {
			...
			var n = function (e, n, s, o, i, l, c) {
				...
				return (
					"" !== c &&
						...
						(u +=
							' title="' +
							(c = (c = c.replace(/"/g, "&quot;")).replace(a.helper.regexes.asteriskDashAndColon, a.helper.escapeCharactersCallback)) +
							'"'),
			...
			return (
				...
				(e = e.replace(/\[([^\[\]]+)]()()()()()/g, n)),
				r.ghMentions &&
					(e = e.replace(/(^|\s)(\\)?(@([a-z\d]+(?:[a-z\d.-]+?[a-z\d]+)*))/gim, function (e, t, n, s, o) {
						if ("\\" === n) return t + s;
						...
						var i = r.ghMentionsLink.replace(/\{u}/g, o),
							l = "";
						return (
							r.openLinksInNewWindow && (l = ' rel="noopener noreferrer" target="¨E95Eblank"'), t + '<a href="' + i + '"' + l + ">" + s + "</a>"
						);
					})),
	...
	a.subParser("autoLinks", function (e, r, t) {
		...
		a.subParser("simplifiedAutoLinks", function (e, r, t) {
			...
			return r.simplifiedAutoLink
				? ((e = t.converter._dispatch("simplifiedAutoLinks.before", e, r, t)),
				  (e = r.excludeTrailingPunctuationFromURLs ? e.replace(d, g(r)) : e.replace(u, g(r))),
				  (e = e.replace(h, m(r, t))),
		...
		a.subParser("ellipsis", function (e, r, t) {
			"use strict";
			return (
				(e = t.converter._dispatch("ellipsis.before", e, r, t)), (e = e.replace(/\.\.\./g, "…")), (e = t.converter._dispatch("ellipsis.after", e, r, t))
			);
		}),
		...
		a.subParser("escapeSpecialCharsWithinTagAttributes", function (e, r, t) {
			"use strict";
			return (
				(e = (e = t.converter._dispatch("escapeSpecialCharsWithinTagAttributes.before", e, r, t)).replace(
					/<\/?[a-z\d_:-]+(?:[\s]+[\s\S]+?)?>/gi,
					function (e) {
		...
		a.subParser("hashHTMLBlocks", function (e, r, t) {
			...
			for (var o = 0; o < n.length; ++o)
				for (
					var i, l = new RegExp("^ {0,3}(<" + n[o] + "\\b[^>]*>)", "im"), c = "<" + n[o] + "\\b[^>]*>", u = "</" + n[o] + ">";
				...
				return (
					...
					(n = r.ghCompatibleHeaderId
						? n
								...
								.toLowerCase()
						: r.rawHeaderId
						? n.replace(/ /g, "-").replace(/&amp;/g, "&").replace(/¨T/g, "¨").replace(/¨D/g, "$").replace(/["']/g, "-").toLowerCase()
			...
			function n(e, r, n, s, o, i, l, c) {
				...
				return (
					c &&
						...
						(h +=
							' title="' +
							(c = c.replace(/"/g, "&quot;").replace(a.helper.regexes.asteriskDashAndColon, a.helper.escapeCharactersCallback)) +
							'"'),
				...
				return (
					...
					(e = e.replace(s, function (e, n, s, i, l, c, u) {
						...
						return (
							...
							n || d.search(/\n{2,}/) > -1
								? ((d = a.subParser("githubCodeBlocks")(d, r, t)), (d = a.subParser("blockGamut")(d, r, t)))
		...
		a.subParser("paragraphs", function (e, r, t) {
			...
			for (
				...
				l.search(/¨(K|G)(\d+)\1/g) >= 0
					? s.push(l)
					: l.search(/\S/) >= 0 && ((l = (l = a.subParser("spanGamut")(l, r, t)).replace(/^([ \t]*)/g, "<p>")), (l += "</p>"), s.push(l));
			}
			for (o = s.length, i = 0; i < o; i++) {
				for (var c = "", u = s[i], d = !1; /¨(K|G)(\d+)\1/.test(u); ) {
					var p = RegExp.$1,
						h = RegExp.$2;
					(c = (c = "K" === p ? t.gHtmlBlocks[h] : d ? a.subParser("encodeCode")(t.ghCodeBlocks[h].text, r, t) : t.ghCodeBlocks[h].codeblock).replace(
						/\$/g,
						"$$$$"
					)),
						(u = u.replace(/(\n\n)?¨(K|G)\d+\2(\n\n)?/, c)),
		...
		a.subParser("strikethrough", function (e, r, t) {
			...
			return (
				r.strikethrough &&
					((e = (e = t.converter._dispatch("strikethrough.before", e, r, t)).replace(/(?:~){2}([\s\S]+?)(?:~){2}/g, function (e, n) {
						return (function (e) {
				...
				return (
					...
					l
						...
						: (c && (t.gTitles[n] = c.replace(/"|'/g, "&quot;")),
						  r.parseImgDimensions && o && i && (t.gDimensions[n] = { width: o, height: i }),
						  "")
				);
			};
			return (
		...
		a.subParser("tables", function (e, r, t) {
			...
			function s(e, n) {
				...
				return (
					(e = e.trim()),
					(r.tablesHeaderId || r.tableHeaderId) && (s = ' id="' + e.replace(/ /g, "_").toLowerCase() + '"'),
