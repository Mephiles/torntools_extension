...
!(function (t, e) {
			...
			(a.rgb.hsl = function (t) {
				...
				(a.hwb.rgb = function (t) {
					var e,
						...
						h = u + d;
					switch (
						(h > 1 && ((u /= h), (d /= h)), (i = 6 * l - (e = Math.floor(6 * l))), 0 != (1 & e) && (i = 1 - i), (a = u + i * ((n = 1 - d) - u)), e)
					) {
						default:
						case 6:
						case 0:
	...
	var _,
		...
		w = {
			...
			inherits: function (t) {
				...
				return (
					(i.prototype = e.prototype), (n.prototype = new i()), (n.extend = w.inherits), t && w.extend(n.prototype, t), (n.__super__ = e.prototype), n
				);
			},
	...
	var B = {
			...
			resolve: function (t, e, n, i) {
				...
				for (a = 0, r = t.length; a < r; ++a)
					if (
						void 0 !== (o = t[a]) &&
						(void 0 !== e && "function" == typeof o && ((o = o(e)), (s = !1)), void 0 !== n && M.isArray(o) && ((o = o[n]), (s = !1)), void 0 !== o)
					)
	...
	z._set("global", {
		elements: {
			point: { radius: 3, pointStyle: "circle", backgroundColor: ht, borderColor: ht, borderWidth: 1, hitRadius: 1, hoverRadius: 4, hoverBorderWidth: 1 },
		},
	});
	var ft = X.extend({
			_type: "point",
	...
	function At(t, e, n) {
		var i,
			...
			l = V.isNullOrUndef(r)
				...
				: -1;
		return (
			V.isNullOrUndef(r) ? ((i = l * n.categoryPercentage), (a = n.barPercentage)) : ((i = r * o), (a = 1)), { chunk: i / o, ratio: a, start: s - i / 2 }
		);
	}
	z._set("bar", {
		hover: { mode: "label" },
