...
!(function (t, e) {
	...
	function W(t) {
		A(I({ putSortable: it, cloneEl: Q, targetEl: z, rootEl: q, oldIndex: J, oldDraggableIndex: et, newIndex: tt, newDraggableIndex: nt }, t));
	}
	var z,
		G,
		U,
	...
	_t &&
		document.addEventListener(
			...
			function (t) {
				if (mt)
					return t.preventDefault(), t.stopPropagation && t.stopPropagation(), t.stopImmediatePropagation && t.stopImmediatePropagation(), (mt = !1);
			},
			!0
		);
	function Pt(t) {
	...
	function Rt(t, e) {
		...
		(this.nativeDraggable = !e.forceFallback && xt),
			...
			e.supportPointer ? u(t, "pointerdown", this._onTapStart) : (u(t, "mousedown", this._onTapStart), u(t, "touchstart", this._onTapStart)),
	...
	(Rt.prototype = {
				...
				if (
					...
					if (((J = F(l)), (et = F(l, t.draggable)), "function" == typeof c)) {
						if (c.call(this, e, l, this))
							return (
								W({ sortable: n, rootEl: s, name: "filter", targetEl: l, toEl: o, fromEl: o }),
								K("filter", n, { evt: e }),
						...
						(c = c.split(",").some(function (t) {
							if ((t = P(s, t.trim(), o, !1)))
								return W({ sortable: n, rootEl: t, name: "filter", targetEl: l, fromEl: o, toEl: o }), K("filter", n, { evt: e }), !0;
						}))
					)
		...
		_prepareDragStart: function (t, e, n) {
			...
			if (n && !z && n.parentNode === r) {
				...
				if (
					...
					(Z = n),
					(ot = a.group),
					(rt = { target: (Rt.dragged = z), clientX: (e || t).clientX, clientY: (e || t).clientY }),
		...
		_emulateDragOver: function () {
			if (at) {
				...
				if ((z.parentNode[j]._isOutsideThisEl(t), e))
					do {
						if (e[j]) {
							if (e[j]._onDragOver({ clientX: at.clientX, clientY: at.clientY, target: t, rootEl: e }) && !this.options.dragoverBubble) break;
						}
						t = e;
			...
			if (!U) {
				...
				if (Ct) {
					...
					gt !== document.body && gt !== document.documentElement
						? (gt === document && (gt = N()), (e.top += gt.scrollTop), (e.left += gt.scrollLeft))
						: (gt = N()),
						(Et = b(gt));
				}
		...
		_onDragStart: function (t, e) {
			...
			K("dragStart", this, { evt: t }),
				Rt.eventCanceled
					...
					: (K("setupClone", this),
					  Rt.eventCanceled ||
							(((Q = S(z)).draggable = !1), (Q.style["will-change"] = ""), this._hideClone(), k(Q, this.options.chosenClass, !1), (Rt.clone = Q)),
					  (n.cloneId = Ht(function () {
							K("clone", n),
								Rt.eventCanceled || (n.options.removeCloneOnHide || q.insertBefore(Q, z), n._hideClone(), W({ sortable: n, name: "clone" }));
					  })),
					  e || k(z, i.dragClass, !0),
					  e
		...
		_onDragOver: function (n) {
			var o,
				...
				p = !1;
			if (!Dt) {
				if ((void 0 !== n.preventDefault && n.cancelable && n.preventDefault(), (s = P(s, e.draggable, l, !0)), M("dragOver"), Rt.eventCanceled))
					return p;
				...
				if (
					...
					c &&
						!e.disabled &&
						(u ? d || (r = !q.contains(z)) : it === this || ((this.lastPutMode = ot.checkPull(this, c, z, n)) && t.checkPut(this, c, z, n))))
				) {
			...
			function N() {
				(tt = F(z)), (nt = F(z, e.draggable)), W({ sortable: f, name: "change", toEl: l, newIndex: tt, newDraggableIndex: nt, originalEvent: n });
			}
		},
		...
		_onDrop: function (t) {
			...
			(tt = F(z)),
				...
				Rt.eventCanceled ||
					...
					this.nativeDraggable && (d(document, "drop", this), d(e, "dragstart", this._onDragStart)),
					this._offMoveEvents(),
					this._offUpEvents(),
					...
					t &&
						...
						z &&
							...
							W({ sortable: this, name: "unchoose", toEl: G, newIndex: null, newDraggableIndex: null, originalEvent: t }),
							q !== G
								? (0 <= tt &&
										(W({ rootEl: G, name: "add", toEl: G, fromEl: q, originalEvent: t }),
										W({ sortable: this, name: "remove", toEl: G, originalEvent: t }),
										W({ rootEl: G, name: "sort", toEl: G, fromEl: q, originalEvent: t }),
										W({ sortable: this, name: "sort", toEl: G, originalEvent: t })),
								  it && it.save())
								: tt !== J &&
								  0 <= tt &&
								  (W({ sortable: this, name: "update", toEl: G, originalEvent: t }),
								  W({ sortable: this, name: "sort", toEl: G, originalEvent: t })),
							Rt.active &&
						...
						(0 == M && 0 == O) ||
							...
							(qt[d].pid = setInterval(
								function () {
									...
									("function" == typeof i && "continue" !== i.call(Rt.dragged.parentNode[j], e, t, n, Gt, qt[this.layer].el)) ||
			...
			new (function () {
				function t(o) {
					...
					o.options.supportPointer
						...
						: (u(document, "mouseup", this._deselectMultiDrag), u(document, "touchend", this._deselectMultiDrag)),
								...
								if (!he)
									if (
										...
										se.splice(se.indexOf(re), 1),
											(oe = null),
											A({ sortable: i, rootEl: n, name: "deselect", targetEl: re, originalEvt: e });
									else {
										if (
											(se.push(re),
											A({ sortable: i, rootEl: n, name: "select", targetEl: re, originalEvt: e }),
											...
											if (~f && ~p && f !== p)
												for (d = f < p ? ((h = f), p) : ((h = p), f + 1); h < d; h++)
													~se.indexOf(u[h]) ||
														...
														se.push(u[h]),
														A({ sortable: i, rootEl: n, name: "select", targetEl: u[h], originalEvt: e }));
										} else oe = re;
										ie = s;
									}
							...
							if (
								...
								for (; se.length; ) {
									...
									k(e, this.options.selectedClass, !1),
										se.shift(),
										A({ sortable: this.sortable, rootEl: this.sortable.el, name: "deselect", targetEl: e, originalEvt: t });
								}
						},
						...
						utils: {
							select: function (t) {
								...
								e &&
									e.options.multiDrag &&
									!~se.indexOf(t) &&
									(ie && ie !== e && (ie.multiDrag._deselectMultiDrag(), (ie = e)), k(t, e.options.selectedClass, !0), se.push(t));
							},
							deselect: function (t) {
								var e = t.parentNode[j],
									n = se.indexOf(t);
