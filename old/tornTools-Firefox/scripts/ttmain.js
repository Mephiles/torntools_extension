...
async function Main(){
	chrome.storage.local.get(["settings", "userdata", "torndata"], function(data){
		...
		if(networth){
			let value = data["userdata"]["networth"]["total"];
			displayNetworth(parseInt(value));
		}
