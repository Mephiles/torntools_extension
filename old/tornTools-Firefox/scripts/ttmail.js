...
function Main(){
	chrome.storage.local.get(["settings"], function(data){
		...
		const mail = settings["other"]["mail"];
		var done = false;
		...
		if(mail){
			...
			console.log("MAIL TURNED OFF");
		}
	});
}

function subMain(){
	var box1 = document.querySelector("#mailcompose_ifr");
	var box2 = document.querySelector("#mailreply_ifr");
	
	if(box1){
		console.log("SETTING BOX");
		box1.style.maxHeight = "2000px";
		box1.style.height = "400px";
		return true;
	} else if(box2){
		console.log("SETTING BOX");
		box2.style.maxHeight = "2000px";
...
function isBox(){
	if(document.querySelector("#mailcompose_ifr") || document.querySelector("#mailreply_ifr")){
		return true;
	}
	return false;
}
