...
window.onload = () => {
	console.log("TornTools", "missions");
	initialize();
	Main();
}

function Main(){
	chrome.storage.local.get(["settings", "userdata", "torndata", "itemlist"], function(data){
		...
		if(missionValues){
			...
			for(let reward of rewards){
				...
				displayMissionPrice(reward, id, quantity, points, itemlist, userPoints);
			}
		} else {
...
async function displayMissionPrice(reward, id, quantity, points, itemlist, userPoints){
