...
window.onload = () => {
	...
	(async () => {
		...
		for(let src in sources){
			// console.log(import("mainModel"));
			try {
				// let funcs = await import(chrome.runtime.getURL(sources[src]));
				// let path = chrome.runtime.getURL(sources[src]);
				// import * as funcs from "models/mainModel.js";
				// let funcs = await import('/models/mainModel.js');
...
// 			tools.setAwardsWindow(window_, status, stats.date);
// 		} else {
// 			console.log("ACHIEVEMENTS TURNED OFF")
// 		}
// 	})
