...
import { checkDevice, findAllElements, findParent, isElementOfTag, sortTable } from "@utils/functions/dom";
import { exposeDebugObjects } from "@utils/functions/pages-debug";
...
export function initializeInternalPage(partialOptions: Partial<InitializeInternalPageOptions> = {}) {
...
export function loadConfirmationPopup(partialOptions: Partial<ConfirmationPopupOptions> = {}): Promise<{ [key: string]: any }> {
...
export function sendMessage(text: string, good: boolean, partialOptions: Partial<MessageOptions> = {}) {
...
export function getPageTheme(): InternalPageTheme {
