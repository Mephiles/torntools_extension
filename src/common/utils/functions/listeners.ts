...
import type { FetchDetails, XHRDetails } from "@utils/functions/request-listener-injector";
import type { ScriptInjector } from "@utils/functions/script-injector";
import { isTabFocused } from "@utils/functions/utilities";
...
export const CUSTOM_LISTENERS: { [K in keyof EventPayloads]: CustomEventListener<K>[] } = (() => {
