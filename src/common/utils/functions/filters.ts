import "./filters.css";
import { userdata } from "@utils/data/database";
import type { WeaponBonusFilter } from "@utils/data/default-database";
import { createCheckbox } from "@utils/elements/checkbox/checkbox";
import { createCheckboxList } from "@utils/elements/checkbox-list/checkbox-list";
import { createMultiSelect, createSelect, type SelectOption } from "@utils/elements/select/select";
import { DualRangeSlider } from "@utils/elements/slider/slider";
import { createTextbox, type TextboxWithoutDescriptionFilter } from "@utils/elements/textbox/textbox";
import { hasAPIData } from "@utils/functions/api";
import { elementBuilder, findAllElements } from "@utils/functions/dom";
import { camelCase } from "@utils/functions/formatting";
import { WEAPON_BONUSES } from "@utils/functions/torn";
import { getUUID } from "@utils/functions/utilities";
import { PHFillFunnel, PHFillFunnelX } from "@utils/icons/phosphor-icons";
