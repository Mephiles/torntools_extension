...
import { getTypedKeyOf, groupBy, type TypedKeyOf } from "@utils/functions/utilities";
import "./table.css";
...
export type TableColumnDef<T, K extends keyof T = keyof T> = {
...
export function stringCellRenderer(value: string | number): BaseElement<Node> {
...
export function createTable<T>(
	...
	const tableHeaders = tableColumnsDefs.map((columnDef) => {
		return createTableHeaderCell(columnDef, {
