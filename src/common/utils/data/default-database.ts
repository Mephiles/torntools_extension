...
import type { DatabaseCache } from "@utils/data/cache";
import type { FetchedFactiondataBasic, FetchedFactiondataWithAccess, FetchedTorndata, FetchedUserdata } from "@utils/data/fetched-data";
import type { DatabaseUsage } from "@utils/data/usage";
import type { TornV1Stock } from "@utils/functions/api-v1.types";
import type { SpecialFilterValue } from "@utils/functions/filters";
...
import type { StoredMigration } from "@/context/migrations/migrations";
...
export const DEFAULT_STORAGE = {
	version: {
		current: new DefaultSetting<string>("string", () => RUNTIME_ENVIRONMENT.getVersion()),
		initial: new DefaultSetting<string>("string", () => RUNTIME_ENVIRONMENT.getVersion()),
