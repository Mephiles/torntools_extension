...
import { settings, torndata, userdata } from "@utils/data/database";
import { hasAPIData } from "@utils/functions/api";
import { elementBuilder, findAllElements, getSearchParameters, isElement, mobile, tablet } from "@utils/functions/dom";
import { formatNumber } from "@utils/functions/formatting";
import { addXHRListener, CUSTOM_LISTENERS, EVENT_CHANNELS } from "@utils/functions/listeners";
import type { XHRDetails } from "@utils/functions/request-listener-injector";
import { requireElement, requireItemsLoaded } from "@utils/functions/requires";
import { getPage, getPageStatus } from "@utils/functions/torn";
