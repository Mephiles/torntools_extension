...
import { calculateRevivePrice, doRequestRevive } from "@utils/functions/api-external-revives";
import { checkDevice, elementBuilder, isElement } from "@utils/functions/dom";
import { capitalizeText } from "@utils/functions/formatting";
import { requireElement } from "@utils/functions/requires";
import { getPage, getSidebarData, getUserDetails, isFlying } from "@utils/functions/torn";
import { TO_MILLIS } from "@utils/functions/utilities";
import { PHFillStethoscope } from "@utils/icons/phosphor-icons";
