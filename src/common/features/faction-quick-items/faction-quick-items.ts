...
import type { QuickFactionItem } from "@utils/data/default-database";
...
import { getItemEnergy, getPageStatus, getUserEnergy } from "@utils/functions/torn";
import { getTornItemType, TORN_ITEMS } from "@utils/functions/torn-items";
import { PHFillPlus, PHX } from "@utils/icons/phosphor-icons";
