...
import { elementBuilder, findAllElements, findParent, hasSidebar, mobile } from "@utils/functions/dom";
import { requireSidebar } from "@utils/functions/requires";
import { ALL_AREAS, CUSTOM_LINKS_PRESET, getSidebarArea, isPageWithSidebar } from "@utils/functions/torn";
