...
export const ACHIEVEMENTS: Achievement[] = [
	...
	},
	{
		...
		stats: () => userdata.education?.complete.length,
	...
	},
	{
		...
		type: "bachelor",
		stats: () => (userdata.education?.complete.includes(42) ? 1 : 0),
	...
	},
	{
		...
		type: "bachelor",
		stats: () => (userdata.education?.complete.includes(13) ? 1 : 0),
	...
	},
	{
		...
		type: "bachelor",
		stats: () => (userdata.education?.complete.includes(87) ? 1 : 0),
	...
	},
	{
		name: "ICT Bachelor",
		type: "bachelor",
		stats: () => (userdata.education?.complete.includes(62) ? 1 : 0),
	...
	},
	{
		...
		type: "bachelor",
		stats: () => (userdata.education?.complete.includes(121) ? 1 : 0),
	...
	},
	{
		...
		type: "bachelor",
		stats: () => (userdata.education?.complete.includes(111) ? 1 : 0),
	...
	},
	{
		...
		type: "bachelor",
		stats: () => (userdata.education?.complete.includes(21) ? 1 : 0),
	...
	},
	{
		name: "Law Bachelor",
		type: "bachelor",
		stats: () => (userdata.education?.complete.includes(102) ? 1 : 0),
	...
	},
	{
		...
		type: "bachelor",
		stats: () => (userdata.education?.complete.includes(33) ? 1 : 0),
	...
	},
	{
		...
		type: "bachelor",
		stats: () => (userdata.education?.complete.includes(69) ? 1 : 0),
	...
	},
	{
		...
		type: "bachelor",
		stats: () => (userdata.education?.complete.includes(51) ? 1 : 0),
	...
	// Crimes 1.0
	{
		...
		requirements: { pages: ["crimes-v1"], condition: () => userdata.personalstats.crimes.version === "v1" },
	},
	{
	...
	},
	{
		...
		requirements: { pages: ["crimes-v2"], condition: () => userdata.personalstats.crimes.version === "v2" },
	},
	{
		name: "Theft",
		group: "crime total",
