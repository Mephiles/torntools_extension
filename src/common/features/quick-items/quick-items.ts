...
import { quick, settings, torndata } from "@utils/data/database";
import type { QuickItem } from "@utils/data/default-database";
...
import { elementBuilder, findAllElements, findParent, isElement, mobile, tablet } from "@utils/functions/dom";
import { formatTime } from "@utils/functions/formatting";
import { addFetchListener, addXHRListener, CUSTOM_LISTENERS, EVENT_CHANNELS, triggerCustomListener } from "@utils/functions/listeners";
import { requireContent, requireItemsLoaded } from "@utils/functions/requires";
import {
	type ExtractedXID,
	extractXIDFromDOM,
	extractXIDFromHTML,
	...
	getPageStatus,
	getUserEnergy,
} from "@utils/functions/torn";
import { getTornItemName, getTornItemType, TORN_ITEMS } from "@utils/functions/torn-items";
import { PHPlus, PHX } from "@utils/icons/phosphor-icons";
