...
import { elementBuilder, executeScript, findAllElements } from "@utils/functions/dom";
import { applyPlural } from "@utils/functions/formatting";
...
function addListener() {
	executeScript(RUNTIME_ENVIRONMENT.getURL("/efficient-rehab--inject.js"));
