...
import { attackHistory, filters, settings, stakeouts, userdata } from "@utils/data/database";
import type { StakeoutData } from "@utils/data/default-database";

import { createCheckbox } from "@utils/elements/checkbox/checkbox";
import { createTable, stringCellRenderer } from "@utils/elements/table/table";
import { createTextbox } from "@utils/elements/textbox/textbox";
import { CUSTOM_API_ERROR, fetchData, hasAPIData } from "@utils/functions/api";
import type { TornstatsSpy, YATASpyResponse } from "@utils/functions/api.types";
import { createContainer, removeContainer } from "@utils/functions/containers";
import { elementBuilder, findAllElements, isHTMLElement, showLoadingPlaceholder } from "@utils/functions/dom";
import { formatNumber, formatTime } from "@utils/functions/formatting";
...
import { getPageStatus, isOwnProfile, millisToNewDay } from "@utils/functions/torn";
import { TO_MILLIS } from "@utils/functions/utilities";
import { PHBoldArrowClockwise, PHFillArrowsOutCardinal, PHFillGear } from "@utils/icons/phosphor-icons";
