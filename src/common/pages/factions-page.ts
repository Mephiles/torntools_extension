...
import { findAllElements, getHashParameters, getSearchParameters, isElement } from "@utils/functions/dom";
import { addFetchListener, addXHRListener, EVENT_CHANNELS, triggerCustomListener } from "@utils/functions/listeners";
import { requireDOMContentLoaded, requireElement } from "@utils/functions/requires";
import { isIntNumber, TO_MILLIS } from "@utils/functions/utilities";
...
export function getFactionSubpage() {
...
export function extractArmorySubcategory(controls: string): string | null {
