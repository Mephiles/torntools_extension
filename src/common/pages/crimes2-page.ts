import { addFetchListener, EVENT_CHANNELS, triggerCustomListener } from "@utils/functions/listeners";
...
export const CRIMES2 = {
	__UNKNOWN__: "__UNKNOWN__",
	BURGLARY: "burglary",
} as const;

export type TornInternalAttemptCrimeDB = {
...
export type TornInternalAttemptCrime = {
	DB: TornInternalAttemptCrimeDB;
};

export function isAttemptCrime(sid: string, step: string, _json: any): _json is TornInternalAttemptCrime {
