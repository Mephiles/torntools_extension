...
<Dialog.Dialog bind:open={dialogOpen}>
	<Dialog.Content class="sm:max-w-md">
		<Dialog.Header>
			...
			<Dialog.Description>Review what will be included before creating the export.</Dialog.Description>
		</Dialog.Header>

		<div class="space-y-3">
			<div class="border-border bg-muted/30 rounded-lg border p-3 text-sm">
				<h3 class="font-medium">Includes:</h3>
				<ul class="text-muted-foreground mt-2 list-disc space-y-0.5 pl-5">
			...
			{#if allowApi}
				<label class="border-border flex items-start gap-2 rounded-lg border p-2 text-sm">
