<script lang="ts">
	...
	import type { DatabaseSettings, DatabaseStockdata, DatabaseUserdata } from "@utils/data/database";
	import type { TornV1Stock } from "@utils/functions/api-v1.types";
	import { applyPlural, dropDecimals, formatNumber } from "@utils/functions/formatting";
	import { getStockBoughtPrice } from "@utils/functions/torn";
