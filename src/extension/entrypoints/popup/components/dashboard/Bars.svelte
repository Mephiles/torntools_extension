<script lang="ts">
	...
	import type { UserV1Bar, UserV1ChainBar } from "@utils/functions/api-v1.types";
	import { formatTime, toSeconds } from "@utils/functions/formatting";
	import {getNextChainBonus, LINKS} from "@utils/functions/torn";
