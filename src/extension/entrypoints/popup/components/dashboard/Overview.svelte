<script lang="ts">
	import { settingsStore, userdataStore } from "@extension/entrypoints/popup/stores/database-store.svelte.js";
	...
	import type {DatabaseSettings, DatabaseUserdata} from "@utils/data/database";
	import { capitalizeText, formatTime } from "@utils/functions/formatting";
	import { ALL_ICONS } from "@utils/functions/torn";
