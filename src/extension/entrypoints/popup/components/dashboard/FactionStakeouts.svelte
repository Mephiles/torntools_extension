<script lang="ts">
	import { factionStakeoutsStore, settingsStore } from "@extension/entrypoints/popup/stores/database-store.svelte.js";
	import { Badge } from "@svelte/components/ui/badge";
	import { Button } from "@svelte/components/ui/button";
	import { ttStorage } from "@utils/context";
	import type { DatabaseFactionStakeouts, DatabaseSettings } from "@utils/data/database";
