<script lang="ts">
	import { settingsStore, stakeoutsStore } from "@extension/entrypoints/popup/stores/database-store.svelte.js";
	import { Button } from "@svelte/components/ui/button";
	import type { DatabaseSettings } from "@utils/data/database";
