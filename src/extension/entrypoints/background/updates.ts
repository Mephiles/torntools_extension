...
import type { StoredFactiondata, StoredFactiondataBasic, StoredFactiondataNoAccess, StoredNpc, StoredNpcs, StoredTorndata } from "@utils/data/default-database";

import { CUSTOM_API_ERROR, FACTION_ACCESS, fetchData, hasAPIData, hasFactionAPIAccess, isTornApiError } from "@utils/functions/api";
import type { LootRangersLoot, TornstatsLoot, YATALoot } from "@utils/functions/api.types";
import type {
...
import { setBadge } from "@utils/functions/extension";
import { applyPlural, capitalizeText, dropDecimals, formatNumber, formatTime } from "@utils/functions/formatting";
import { getHospitalizationReason, getNextChainBonus, hasFinishedEducation, LINKS, MAX_MISSIONS } from "@utils/functions/torn";
import { getUTCTodayAtTime, hasTimePassed, isSameUTCDay, TO_MILLIS } from "@utils/functions/utilities";
import type {
	AttacksResponse,
