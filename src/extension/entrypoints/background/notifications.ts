...
import { notificationHistory, notifications, setNotificationHistory, settings } from "@utils/data/database";
import type { TTNotification } from "@utils/data/default-database";

import { hasInteractionSupport, hasSilentSupport } from "@utils/functions/browser";
