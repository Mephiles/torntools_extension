import { registerExtensionContext } from "@extension/context/extension-context";
...
import { BackgroundService } from "@extension/services/BackgroundService";
...
import { type Database, loadDatabase, type RecursivePartial, storageListeners, version, type Writable } from "@utils/data/database";
...
import { migrateDatabase } from "@/context/migrations/migrate-database";
