	...
	settings: {
		...
		notifications: {
			...
			types: {
				...
				chainTimerEnabled: new DefaultSetting({ type: "boolean", defaultValue: false }),
				chainBonusEnabled: new DefaultSetting({ type: "boolean", defaultValue: false }),
				leavingHospitalEnabled: new DefaultSetting({ type: "boolean", defaultValue: false }),
				landingEnabled: new DefaultSetting({ type: "boolean", defaultValue: false }),
				cooldownDrugEnabled: new DefaultSetting({ type: "boolean", defaultValue: false }),
				cooldownBoosterEnabled: new DefaultSetting({ type: "boolean", defaultValue: false }),
				cooldownMedicalEnabled: new DefaultSetting({ type: "boolean", defaultValue: false }),
