...
const WEAPON_BONUSES = ["Achilles", "Assassinate", "Backstab", "Berserk", "Bleed", "Blindside", "Bloodlust", "Comeback", "Conserve", "Cripple", "Crusher", "Cupid", "Deadeye", "Deadly", "Disarm", "Double Tap", "Double-edged", "Empower", "Eviscerate", "Execute", "Expose", "Finale", "Focus", "Frenzy", "Fury", "Grace", "Home Run", "Irradiate", "Motivation", "Paralyzed", "Parry", "Penetrate", "Plunder", "Powerful", "Proficience", "Puncture", "Quicken", "Rage", "Revitalize", "Roshambo", "Slow", "Smurf", "Specialist", "Stricken", "Stun", "Suppress", "Sure Shot", "Throttle", "Warlord", "Weaken", "Wind-up", "Wither"];
