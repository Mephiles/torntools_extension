...
const ALL_ICONS = [
	...
	{ icon: "icon2", description: "Offline" },
	{ icon: "icon6", description: "Male" },
	{ icon: "icon7", description: "Female" },
	{ icon: "icon72", description: "New player" },
	{ icon: "icon3", description: "Donator" },
	{ icon: "icon4", description: "Subscriber" },
	{ icon: "icon11", description: "Staff" },
	{ icon: "icon10", description: "Committee" },
	{ icon: "icon8", description: "Marriage" },
	{ icon: "icon5", description: "Level 100" },
	{ icon: "icon21", description: "Army job" },
	{ icon: "icon22", description: "Casino job" },
	{ icon: "icon23", description: "Medical job" },
	{ icon: "icon24", description: "Grocer job" },
	{ icon: "icon25", description: "Lawyer job" },
	{ icon: "icon26", description: "Education job" },
	{ icon: "icon73", description: "Company director" },
	{ icon: "icon27", description: "Company employee" },
	{ icon: "icon83", description: "Company recruit" },
	{ icon: "icon74", description: "Faction leader / co-leader" },
	{ icon: "icon9", description: "Faction member" },
	{ icon: "icon81", description: "Faction recruit" },
	{ icon: "icon75", description: "Territory war (defending)" },
	{ icon: "icon76", description: "Territory war (assaulting)" },
	{ icon: "icon19", description: "Education in progress" },
	{ icon: "icon20", description: "Education completed" },
	{ icon: "icon29", description: "Investment in progress" },
	{ icon: "icon30", description: "Investment completed" },
	{ icon: "icon31", description: "Cayman islands bank" },
	{ icon: "icon32", description: "Property vault" },
	{ icon: "icon33", description: "Loan" },
	{ icon: "icon34", description: "Items in auction" },
	{ icon: "icon35", description: "Items in bazaar" },
	{ icon: "icon36", description: "Items in item market" },
	{ icon: "icon54", description: "Points market" },
	{ icon: "icon38", description: "Stocks owned" },
	{ icon: "icon84", description: "Dividend collection ready" },
	{ icon: "icon37", description: "Trade in progress" },
	{ icon: "icon68", description: "Reading book" },
	{ icon: "icon71", description: "Traveling" },
	{ icon: "icon17", description: "Racing in progress" },
	{ icon: "icon18", description: "Racing completed" },
	{ icon: "icon85", description: "Organized crime being planned" },
	{ icon: "icon86", description: "Organized crime ready" },
	{ icon: "icon13", description: "Bounty" },
	{ icon: "icon28", description: "Cashier's checks" },
	{ icon: "icon55", description: "Auction high bidder" },
	{ icon: "icon56", description: "Auction outbid" },
	{ icon: "icon15", description: "Hospital" },
	{ icon: "icon82", description: "Hospital early discharge" },
	{ icon: "icon16", description: "Jail" },
	{ icon: "icon70", description: "Federal jail" },
	{ icon: "icon12", description: "Low life" },
	{ icon: "icon39", description: "Booster cooldown (0-6hr)" },
	{ icon: "icon40", description: "Booster cooldown (6-12hr)" },
	{ icon: "icon41", description: "Booster cooldown (12-18hr)" },
	{ icon: "icon42", description: "Booster cooldown (18-24hr)" },
	{ icon: "icon43", description: "Booster cooldown (24hr+)" },
	{ icon: "icon44", description: "Medical cooldown (0-90m)" },
	{ icon: "icon45", description: "Medical cooldown (90-180m)" },
	{ icon: "icon46", description: "Medical cooldown (180m-270m)" },
	{ icon: "icon47", description: "Medical cooldown (270-360m)" },
	{ icon: "icon48", description: "Medical cooldown (360m+)" },
	{ icon: "icon49", description: "Drug cooldown (0-10m)" },
	{ icon: "icon50", description: "Drug cooldown (10-60m)" },
	{ icon: "icon51", description: "Drug cooldown (1-2hr)" },
	{ icon: "icon52", description: "Drug cooldown (2-5hr)" },
	{ icon: "icon53", description: "Drug cooldown (5hr+)" },
	{ icon: "icon57", description: "Drug addiction (1-4%)" },
	{ icon: "icon58", description: "Drug addiction (5-9%)" },
	{ icon: "icon59", description: "Drug addiction (10-19%)" },
	{ icon: "icon60", description: "Drug addiction (20-29%)" },
	{ icon: "icon61", description: "Drug addiction (30%+)" },
	{ icon: "icon63", description: "Radiation sickness (1-17%)" },
	{ icon: "icon64", description: "Radiation sickness (18-34%)" },
	{ icon: "icon65", description: "Radiation sickness (35-50%)" },
	{ icon: "icon66", description: "Radiation sickness (51-67%)" },
	{ icon: "icon67", description: "Radiation sickness (68%+)" },
	{ icon: "icon78", description: "Upkeep due (4-6%)" },
	{ icon: "icon79", description: "Upkeep due (6-8%)" },
