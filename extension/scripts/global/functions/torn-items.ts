...
const TORN_ITEMS: TornV1Items = {
	...
	69: {
		...
		effect: "Used to plant a virus in Crimes 1.0.",
		requirement: "",
		type: "Tool",
		weapon_type: null,
		buy_price: 0,
	...
	70: {
		...
		effect: "Used to plant a virus in Crimes 1.0.\nUsed by the Hacker role during the Counter Offer scenario.",
		requirement: "",
		type: "Tool",
		weapon_type: null,
		buy_price: 0,
	...
	71: {
		...
		effect: "Used to plant a virus in Crimes 1.0.\nUsed by the Hacker role during the Sneaky Git Grab scenario.",
		requirement: "",
		type: "Tool",
		weapon_type: null,
		buy_price: 0,
		sell_price: 10000,
		market_value: 2313148,
		circulation: 162671,
	...
	73: {
		...
		effect: "Used to plant a virus in Crimes 1.0.\nUsed by the Hacker role during the Stacking the Deck scenario.\nUsed by the Hacker role during the Manifest Cruelty scenario.",
		requirement: "",
		type: "Tool",
		weapon_type: null,
		buy_price: 0,
		sell_price: 200000,
		market_value: 1318710,
		circulation: 221297,
	...
	159: {
		...
		effect: "Required by the Car Thief role during the No Reserve scenario.",
		requirement: "",
		type: "Tool",
		weapon_type: null,
		buy_price: 25,
	...
	172: {
		name: "Gasoline",
		description:
			"Capable of storing five gallons of pure liquid warehouse repellent, this rusty red can makes it easy to transport gasoline across the city to your destination of choice. It burns hotter and spreads faster than other liquids, but it stinks to high heaven and leaves its fingerprints everywhere. If you're an arsonist, that destination could be a church, a brothel, or something weird like a yurt. If you're Toxic Terry, that gas is going on a straight shot to your digestive tract.",
		effect: "Dangerously fuels a fire with high suspicion in Arson.\nUsed during the burning method in Disposal.\nUsed by the Arsonist role during the Market Forces scenario.",
		requirement: "",
		type: "Material",
		weapon_type: null,
		buy_price: 95,
	...
	190: {
		...
		effect: "Used by the Bomber roles during the Bidding War scenario.\nUsed by the Bomber role during the Gone Fission scenario.",
		requirement: "",
		type: "Material",
		weapon_type: null,
		buy_price: 0,
	...
	255: {
		...
		effect: "Dangerously and unpredictably ignites a fire with high spread, visibility, and suspicion in Arson.",
		requirement: "",
		type: "Secondary",
		weapon_type: "Heavy artillery",
		buy_price: 3000000,
		sell_price: 2500000,
		market_value: 2531781,
		circulation: 88645,
	...
	326: {
		...
		effect: "Required for counterfeiting money in Crimes 1.0.",
		requirement: "",
		type: "Material",
		weapon_type: null,
		buy_price: 75000,
	...
	327: {
		name: "Blank Casino Chips",
		description:
			"These blank casino chips are made from moulded clay-composite resin, bulked out with a sneaky little metal insert so they clack like the real thing. Right now they carry no markings or branding, which means they can be customized to suit the owner’s wishes. At a glance, these blanks might dupe an old fella with cataracts into thinking they’re legit. But only a fool would try to fatten their stack at Lucky Shots with fakes, as if the bouncers catch you they'll make sure you cash in your chips for the last time, out back by the dumpsters... with hammers.",
		effect: "Used by the Hustler role during the Plucking the Lotus Petal scenario.\nRequired for counterfeiting casino tokens in Crimes 1.0.",
		requirement: "",
		type: "Material",
		weapon_type: null,
		buy_price: 20000,
	...
	348: {
		...
		effect: "Immunity to Radiation, Nerve Gas, Tear Gas, and Pepper Spray.",
		requirement: "",
		type: "Defensive",
		weapon_type: null,
		buy_price: 0,
	...
	361: {
		...
		requirement: "Must be under the effect of radiation poisoning.",
		type: "Medical",
		weapon_type: null,
		buy_price: 900000,
		sell_price: 700000,
		market_value: 1555317,
		circulation: 233312,
	...
	394: {
		...
		effect: "Used during the disposal of a vehicle in Disposal.",
		requirement: "",
		type: "Temporary",
		weapon_type: "Temporary",
		buy_price: 5,
	...
	455: {
		name: "The Companion Script : Abdullah",
		description:
	...
	456: {
		name: "The Companion Script : Ubay",
		description:
	...
	464: {
		name: "Melatonin",
		description:
			"Melatonin reduces the effects of disease and pain and in other tests, Melatonin can possibly increase one's concentration levels. When used in combat, this needle will provide a massive bonus to speed.",
	...
	465: {
		name: "Serotonin",
		description:
			"Serotonin acts as a pain killer, and helps with blood clotting. Tests on animals show that serotonin can make the animal more dominant and aggressive. When used in combat, this needle will provide a massive bonus to defense, and may even replenish some life.",
	...
	544: {
		...
		description:
			"Picture the scene: you're trapped on an icy mountain slope, exposed to the elements. You've cobbled together some twigs, pulled out your lighter, and are desperately trying to get a fire going to hold off the frostbite chewing through your toes. But there's one problem - a light breeze. The wind snuffs out the flame before it can catch. That's why you don't risk your life with a cheap disposable. The Windproof Lighter, with its refillable butane tank, reinforced metal casing, and catalytic burner, is built to keep burning through the most trying circumstances. Because no one wants their cause of death recorded as \"it was a bit windy\".",
		effect: "Improves Arson crime exp & skill gains by 5%.\nIgnites a fire in Arson.",
		requirement: "",
		type: "Enhancer",
		weapon_type: null,
		buy_price: 0,
		sell_price: 0,
		market_value: 6974904,
		circulation: 68063,
	...
	567: {
		...
		effect: "Improves Pickpocketing crime exp & skill gains by 5%.\nRequired by the Pickpocket role during the Gone Fission scenario.",
		requirement: "",
		type: "Enhancer",
		weapon_type: null,
		buy_price: 0,
	...
	568: {
		...
		effect: "Improves success rate for the Larceny crime.\nUnlocks additional outcomes for certain targets in Burglary.\nRequired by the Looter roles during the Mob Mentality scenario.\nRequired by the Robber role during the Bidding War scenario.\nRequired by the Cat Burglar role during the Stacking the Deck scenario.",
		requirement: "",
		type: "Tool",
		weapon_type: null,
		buy_price: 0,
	...
	569: {
		...
		effect: "Improves success rate for the Armed Robbery crime in Crimes 1.0.",
		requirement: "",
		type: "Enhancer",
		weapon_type: null,
		buy_price: 0,
	...
	570: {
		...
		effect: "Improves success rate for the Transporting Drugs crime in Crimes 1.0.",
		requirement: "",
		type: "Enhancer",
		weapon_type: null,
		buy_price: 0,
	...
	573: {
		...
		effect: "Improves success rate for the Grand Theft Auto crime in Crimes 1.0.",
		requirement: "",
		type: "Enhancer",
		weapon_type: null,
		buy_price: 0,
		sell_price: 0,
		market_value: 1823498,
		circulation: 73961,
	...
	574: {
		...
		effect: "Improves success rate for the Robbing The Pawn Shop crime in Crimes 1.0.",
		requirement: "",
		type: "Enhancer",
		weapon_type: null,
		buy_price: 0,
	...
	575: {
		...
		effect: "Improves success rate for the Counterfeiting crime in Crimes 1.0.",
		requirement: "",
		type: "Enhancer",
		weapon_type: null,
		buy_price: 0,
	...
	576: {
		...
		effect: "Improves success rate for the Kidnapping crime in Crimes 1.0.\nUsed by the Engineer role during the No Reserve scenario.\nUsed by the Assassin role during the Clinical Precision scenario.",
		requirement: "",
		type: "Enhancer",
		weapon_type: null,
		buy_price: 0,
	...
	577: {
		...
		effect: "Improves success rate for the Arms Trafficking crime in Crimes 1.0.",
		requirement: "",
		type: "Enhancer",
		weapon_type: null,
		buy_price: 0,
		sell_price: 0,
		market_value: 1365000,
		circulation: 73862,
	...
	579: {
		...
		effect: "Improves success rate for the Hacking crime in Crimes 1.0.\nRequired by the Techie role during the Sneaky Git Grab scenario.",
		requirement: "",
		type: "Enhancer",
		weapon_type: null,
		buy_price: 0,
	...
	642: {
		...
		effect: "Immunity to Pepper Spray.",
		requirement: "",
		type: "Defensive",
		weapon_type: null,
		buy_price: 0,
	...
	643: {
		...
		effect: "Required by the Imitator role during the Gaslight the Way scenario.",
		requirement: "",
		type: "Defensive",
		weapon_type: null,
		buy_price: 14000,
	...
	644: {
		...
		effect: "Immunity to Flash Grenades and Pepper Spray.",
		requirement: "",
		type: "Defensive",
		weapon_type: null,
		buy_price: 0,
	...
	670: {
		...
		effect: "Immunity to Nerve Gas, Tear Gas, and Pepper Spray.",
		requirement: "",
		type: "Defensive",
		weapon_type: null,
		buy_price: 0,
		sell_price: 0,
		market_value: 1411122223,
		circulation: 705,
	...
	680: {
		...
		effect: "Immunity to Concussion Grenades and Pepper Spray.",
		requirement: "",
		type: "Defensive",
		weapon_type: null,
		buy_price: 0,
	...
	731: {
		...
		requirement: "Requires the Intravenous Therapy education course.",
		type: "Medical",
		weapon_type: null,
		buy_price: 15000,
		sell_price: 11250,
		market_value: 16638,
		circulation: 17688498,
	...
	814: {
		name: "Tyrosine",
		description:
			"Tyrosine acts as a mental alertness booster by synthesising itself into dopamine; a compound which improves the transport of messages between nerve cells and neurons. Tests on animals show that Tyrosine can have an effect on mood and alertness. When used in combat, this needle will provide a massive bonus to dexterity.",
	...
	833: {
		name: "Sand",
		description:
			"There's nothing worse than getting sand in your eyes, especially in the middle of a fight with an aggressive stranger. Thankfully, sand fights are now illegal in Torn, meaning this substance can only be used for wholesome activities like forging keys and cop badges. This superfine material is most commonly found along the low tide line at the beach, where waves, wind, and the stresses of ocean life have ground regular sand down into an almost powder like substance. You might also find some in your sandwiches, if you're really unlucky.",
		effect: "Required during the production of forgery projects.\nDampens a fire's intensity and momentum with medium risk in Arson.",
		requirement: "",
		type: "Material",
		weapon_type: null,
		buy_price: 0,
	...
	874: {
		...
		effect: "Can be used to initiate simulated attacks when equipped.\nCan adopt any weapon bonuses currently in existence.",
		requirement: "",
		type: "Secondary",
		weapon_type: "Rifle",
		buy_price: 0,
	...
	884: {
		...
		effect: "Required by the Reviver role during the Manifest Cruelty scenario.",
		requirement: "",
		type: "Tool",
		weapon_type: null,
		buy_price: 0,
	...
	886: {
		...
		effect: "Unlocks additional outcomes in Shoplifting.",
		requirement: "",
		type: "Tool",
		weapon_type: null,
		buy_price: 0,
	...
	893: {
		...
		effect: "Unlocks additional outcomes at the Subway in Search for Cash.",
		requirement: "",
		type: "Tool",
		weapon_type: null,
		buy_price: 0,
	...
	906: {
		...
		effect: "Required for the disposal of firearms in Disposal.",
		requirement: "",
		type: "Tool",
		weapon_type: null,
		buy_price: 0,
	...
	914: {
		name: "CR7 Doll",
		description:
			"Awarded to Tiller in recognition of his speed, skill and magnificent thighs. Unfortunately, the doll should only be viewed from the back, as the face looks nothing like him.",
		effect: "",
		requirement: "",
		type: "Collectible",
		weapon_type: null,
	...
	956: {
		...
		effect: "Used to copy counterfeit DVDs in Crimes 1.0.",
		requirement: "",
		type: "Material",
		weapon_type: null,
		buy_price: 80,
	...
	980: {
		...
		effect: "Unlocks additional outcomes in Graffiti.",
		requirement: "",
		type: "Tool",
		weapon_type: null,
		buy_price: 0,
	...
	981: {
		...
		effect: "Unlocks additional outcomes in Graffiti.\nRequired by the Engineer role during the Counter Offer scenario.",
		requirement: "",
		type: "Tool",
		weapon_type: null,
		buy_price: 0,
	...
	1012: {
		...
		effect: "Causes low-level radiation poisoning. Increases medical cooldown by 30 mins.\nUsed by the Cleaner role during the Clinical Precision scenario.",
		requirement: "Requires the Intravenous Therapy education course.",
		type: "Medical",
		weapon_type: null,
		buy_price: 0,
	...
	1080: {
		...
		effect: "Required by the Enforcer and Muscle roles during the Honey Trap scenario.",
		requirement: "",
		type: "Supply Pack",
		weapon_type: null,
		buy_price: 0,
	...
	1084: {
		...
		effect: "Used during the production of projects in Forgery.\nUnlocks additional outcomes for certain targets in Burglary.",
		requirement: "",
		type: "Tool",
		weapon_type: null,
		buy_price: 0,
	...
	1094: {
		...
		effect: "Used by the Imitator role during the Clinical Precision scenario.",
		requirement: "",
		type: "Material",
		weapon_type: null,
		buy_price: 0,
	...
	1143: {
		...
		effect: "Used during the disposal of biological waste in Disposal.",
		requirement: "",
		type: "Material",
		weapon_type: null,
		buy_price: 0,
	...
	1175: {
		...
		effect: "Interdimensional opponent becomes drawn into our physical realm.",
		requirement: "",
		type: "Temporary",
		weapon_type: "Temporary",
		buy_price: 0,
	...
	1176: {
		name: "Greater Arca Fortunae",
		description:
			"The Greater Arca Fortunae is a vast, mystical trove whose contents are said to embody the deepest desires of those who claim it. None know how this object is forged, nor the source of its power, only that it is granted to those who excel in battle against the loam-dweller M'aol and his spectral kin. Within the Arca's ornate shell lies a bounty beyond reckoning, a hoard numbering in the hundreds of rare and coveted spoils.",
		effect: "Provides a large number of Halloween treats when opened.",
		requirement: "",
		type: "Supply Pack",
		weapon_type: null,
		buy_price: 0,
	...
	1201: {
		...
		effect: "Used during the disposal of a dead body in Disposal.\nUnlocks additional outcomes for certain targets in Burglary.",
		requirement: "",
		type: "Material",
		weapon_type: null,
		buy_price: 0,
	...
	1202: {
		...
		effect: "Unlocks additional outcomes for certain targets in Burglary.",
		requirement: "",
		type: "Tool",
		weapon_type: null,
		buy_price: 0,
	...
	1203: {
		...
		effect: "Unlocks additional outcomes for certain targets in Burglary.\nRequired by the Picklock role during the Pet Project scenario.\nRequired by the Picklock role during the Best of the Lot scenario.\nRequired by the Picklock role during the Counter Offer scenario.\nRequired by the Picklock role during the First Aid and Abet scenario.",
		requirement: "",
		type: "Tool",
		weapon_type: null,
		buy_price: 0,
	...
	1212: {
		...
		effect: "Used during the disposal of vehicles and murder weapons in Disposal.",
		requirement: "",
		type: "Material",
		weapon_type: null,
		buy_price: 0,
	...
	1213: {
		...
		effect: "Used during the disposal of body parts and dead bodies in Disposal.",
		requirement: "",
		type: "Material",
		weapon_type: null,
		buy_price: 0,
	...
	1217: {
		...
		effect: "Used by the Decoy role during the First Aid and Abet scenario.",
		requirement: "",
		type: "Material",
		weapon_type: null,
		buy_price: 0,
	...
	1219: {
		name: "Oxygen Tank",
		description:
			"Oxygen is the invisible enabler. Not only does it encourage you to live, the presence of O2 also helps fire burn to new heights. This tank's contents won't start a fire on their own, but they will encourage it once it's got going, like the bartender to your drunk uncle at a family wedding. Clean, odorless, and suspiciously innocent-looking, oxygen is the opposite of your average Torn citizen - though once released, it's every bit as destructive.",
		effect: "Safely intensifies a fire with high spread in Arson.\nBoosts a fire's intensity across all areas in Arson.",
		requirement: "",
		type: "Material",
		weapon_type: null,
		buy_price: 0,
	...
	1223: {
		...
		effect: "Required by the Interrogator role during the Manifest Cruelty scenario.",
		requirement: "",
		type: "Tool",
		weapon_type: null,
		buy_price: 0,
	...
	1230: {
		...
		effect: "Required by the Bomber role during the Crane Reaction scenario.",
		requirement: "",
		type: "Tool",
		weapon_type: null,
		buy_price: 0,
	...
	1233: {
		...
		effect: "Required for the disposal of building debris and industrial waste in Disposal.",
		requirement: "",
		type: "Tool",
		weapon_type: null,
		buy_price: 995,
	...
	1234: {
		...
		effect: "Required for the burying disposal method in Disposal.",
		requirement: "",
		type: "Tool",
		weapon_type: null,
		buy_price: 0,
	...
	1235: {
		...
		effect: "Dangerously dampens a fire's intensity and momentum with high risk in Arson.",
		requirement: "",
		type: "Tool",
		weapon_type: null,
		buy_price: 0,
	...
	1247: {
		name: "Bull Semen",
		description:
			"This vial contains a potent blend of semen extracted from the most virile bulls in Torn City. The motility and morphology of these sperm is so impressive that they have been seen punching through solid steel chastity devices in order to reach the egg. As viscous as cold treacle, this executive bovine seed is almost impossible to clean off when spilled on your trousers. Try explaining that to your spouse.",
		effect: "",
		requirement: "",
		type: "Other",
		weapon_type: null,
	...
	1249: {
		...
		effect: "Used during the dissolving disposal method in Disposal.",
		requirement: "",
		type: "Material",
		weapon_type: null,
		buy_price: 24250,
	...
	1258: {
		...
		effect: "Required by the Lookout role during the Stage Fright scenario.\nRequired by the Lookout role during the Crane Reaction scenario.",
		requirement: "",
		type: "Tool",
		weapon_type: null,
		buy_price: 0,
	...
	1261: {
		...
		effect: "Unlocks additional outcomes at the Beach in Search for Cash.",
		requirement: "",
		type: "Tool",
		weapon_type: null,
		buy_price: 0,
	...
	1264: {
		...
		description:
			"Potassium Nitrate is a low-profile fuel enhancer that keeps fires discreet while making them burn meaner. Try buying a kilo of potassium online, and the feds will think you've gone bananas. Buy a kilo of its nitrate variant, and they'll assume you're halfway through writing your own manifesto. Also known as saltpeter, this crystalline salt acts as the oxidizing agent in gunpowder. On its own it won't do much, but mix it with fuel and you’ll get something dangerously volatile that scorches one spot hotter than the inside of a McDonald’s apple pie.",
		effect: "Safely accelerates a fire within a confined area with low suspicion in Arson.\nBoosts a fire's intensity in a single area in Arson.",
		requirement: "",
		type: "Material",
		weapon_type: null,
		buy_price: 3750,
	...
	1284: {
		...
		effect: "Required by the Robber role during the Bidding War scenario.",
		requirement: "",
		type: "Tool",
		weapon_type: null,
		buy_price: 0,
	...
	1350: {
		...
		effect: "Required by the Imitator and Negotiator roles during the Leave No Trace scenario.\nRequired by the Imitator role during the Best of the Lot scenario.",
		requirement: "",
		type: "Tool",
		weapon_type: null,
		buy_price: 0,
	...
	1362: {
		...
		effect: "Required by the Muscle role during the Pet Project scenario.",
		requirement: "",
		type: "Tool",
		weapon_type: null,
		buy_price: 0,
		sell_price: 25,
		market_value: 1724172,
		circulation: 56893,
	...
	1380: {
		...
		effect: "Required by the Car Thief role during the Smoke and Wing Mirrors scenario.",
		requirement: "",
		type: "Tool",
		weapon_type: null,
		buy_price: 0,
		sell_price: 0,
		market_value: 2003589,
		circulation: 51985,
	...
	1381: {
		...
		effect: "Used by the Thief role during the Cash Me if You Can scenario.\nUsed by the Imitator role during the Stacking the Deck scenario.\nUsed by the Imitator role during the Ace in the Hole scenario.\nUsed by the Imitator roles during the Gaslight the Way scenario.",
		requirement: "",
		type: "Tool",
		weapon_type: null,
		buy_price: 0,
	...
	1383: {
		...
		effect: "Required by the Imitator role during the Smoke and Wing Mirrors scenario.\nRequired by the Imitator role during the Gone Fission scenario.",
		requirement: "",
		type: "Tool",
		weapon_type: null,
		buy_price: 0,
	...
	1429: {
		...
		effect: "Used by the Muscle role during the Blast from the Past scenario.\nUsed by the Muscle role during the Break the Bank scenario.\nUsed by the Looter and Robber roles during the Counter Offer scenario.\nUsed by the Cat Burglar role during the Manifest Cruelty scenario.\nUsed by the Hijacker role during the Gone Fission scenario.",
		requirement: "",
		type: "Material",
		weapon_type: null,
		buy_price: 25,
	...
	1452: {
		name: "Kevin McCallister Mask '24",
		description:
	...
	1457: {
		name: "Kerosene",
		description:
			"For the arsonist who values restraint. Kerosene burns slower and with more control than its spicy cousin, Gasoline, offering a calculated solution to your fire-based problems. Ideal for indoor use, setting fires around pets, or when you need to send a message without turning an entire zip code into a Hiroshima tribute act. It’s discreet, harder to trace, and has a knack for giving one corner of the blaze that extra shove.",
		effect: "Fuels a fire with low suspicion in Arson.\nBoosts a fire's momentum in a single area in Arson. ",
		requirement: "",
		type: "Material",
		weapon_type: null,
		buy_price: 0,
	...
	1458: {
		name: "Diesel",
		description:
			"Thicker, darker, and a little bit sulky, diesel is the accelerant equivalent of a big tiddy goth girlfriend. Slow to start, too proud to spread for attention, but once it gets going it's an absolute smoke show. The fumes from a diesel fire will announce your actions to everyone within a half-mile radius, so if you're looking for an audience, this is the juice for the job. A touch safer to spark than its liquid cousins, but the trade-off is a plume that leaves no doubt who lit it.",
		effect: "Safely fuels a fire with high visibility in Arson.\nReduces a target's ignition risk in Arson.",
		requirement: "",
		type: "Material",
		weapon_type: null,
		buy_price: 0,
	...
	1459: {
		name: "Hydrogen Tank",
		description:
			'Hydrogen is the reason airships went out of fashion. Stored under pressure and desperate to escape, this gas spreads fire like piss in a paddling pool. It gets everywhere fast, turning small flames into sprawling chaos before you can say "Rauchen ist hier nicht erlaubt, mein Herr." When used properly, Hydrogen leaves barely a trace of its existence behind in the aftermath. So long as you remember to pick up the big-ass metal tank when you\'re done. As Torn\'s mascot Trashie the Trashcan says, "Littering is Shittering!"',
		effect: "Dangerously intensifies a fire with high spread in Arson.\nSpreads a fire's existing intensity and momentum across multiple areas in Arson. ",
		requirement: "",
		type: "Material",
		weapon_type: null,
		buy_price: 0,
	...
	1460: {
		name: "Methane Tank",
		description:
			"Naturally produced by decaying matter, methane is what the planet exhales while it dies. This tank of liquid farts is best deployed when you want a fire to erupt fast and furious, blasting heat across the room before it has a chance to hit back. It spreads wide, burns hot, and vanishes quick. Let methane out inside a building and the whole place will reek like the inside of an arse, but once it's burned away it leaves behind the telltale signs of a natural gas leak, making even the most suspicious fire look as innocent as a baby with an alibi.",
		effect: "Intensifies a fire with high spread in Arson.\nReduces a fire's accumulated suspicion in Arson. ",
		requirement: "",
		type: "Material",
		weapon_type: null,
		buy_price: 0,
	...
	1461: {
		name: "Thermite",
		description:
			"A small pile of thermite looks harmless until it decides to eat through steel like it's cotton candy. This high-temperature blend of metal powder and oxide produces a reaction so hot it does serious damage wherever it's placed, accelerating the destruction of your target. Ideal for when you want to commit arson and host a science lesson at the same time. Wanna know how jet fuel melts steel beams? Add a little of this to your arson repertoire and find out. Just stand well back after you've lit this stuff.\n",
		effect: "Dangerously accelerates a fire within a confined area in Arson.\nIncreases the rate of damage sustained by targets in Arson.\nUsed by the Engineer role during the Gone Fission scenario.",
		requirement: "",
		type: "Material",
		weapon_type: null,
		buy_price: 0,
	...
	1462: {
		...
		description:
			"Light, silvery, and deceptively festive, magnesium shavings burn with a blinding white flame that's brighter than your neighbor's clever son, Clancy. This substance laughs in the face of water and keeps the party going until everything nearby is ash, creating an intense heat that is difficult to put out. It's hardly the most subtle way of feeding a fire, but sometimes, it's just nice to be noticed.",
		effect: "Accelerates a fire within a confined area with high suspicion and visibility in Arson.\nReduces the effect of firefighters and dampening in Arson.",
		requirement: "",
		type: "Material",
		weapon_type: null,
		buy_price: 22000,
	...
	1463: {
		...
		description:
			"When you've gotten a little over-excited, Mr. Fire Extinguisher is there to help you subdue even the most out-of-control fire. How do we know this object is a male? That's easy. It comes with a hose, spurts white foam over multiple surfaces, makes a lot of noise about it, and leaves behind a mess you’ll be explaining for days.",
		effect: "Safely dampens a fire's intensity and momentum with low risk in Arson.",
		requirement: "",
		type: "Material",
		weapon_type: null,
		buy_price: 0,
	...
	1464: {
		name: "Mermaid Tiara",
		description:
			"This glittery and whimsical tiara, decorated with the ocean's treasures, turns you into a real mermaid! If you are having a bad day put it on, take a swim, feel all the weight around you vanishing. At least that's how Jairyll would do it.",
		effect: "",
		requirement: "",
		type: "Collectible",
		weapon_type: null,
		...
		market_value: 0,
		circulation: 20,
		image: "https://www.torn.com/images/items/1464/large.png",
		tradeable: true,
	},
	1465: {
		name: "Cluster Ring",
		description:
			'This ostentatious four-stone cluster ring screams "I have more money than sense" so loudly that even the dead will rise up to rob you. Boasting a ruby, an emerald, a sapphire, and a stunning yellow diamond, this exquisite piece decorates your digits with more than enough value to make severing your hand a profitable venture. If you want to let your beloved know that you\'d absolutely trust them with your vault access, there is no better engagement gift than this opulent cluster ring.',
		effect: "",
		requirement: "",
		type: "Jewelry",
		weapon_type: null,
		buy_price: 0,
		sell_price: 2250000,
		market_value: 3423236,
		circulation: 5451,
		image: "https://www.torn.com/images/items/1465/large.png",
		tradeable: true,
	},
	1466: {
		name: "Lighter",
		description:
			"With vaping on the rise and cigarette smokers banished to the fringes of society, you might think the humble butane lighter has had its day. Not so. The scented candle boom, backed by the steady trade from arsonists and fart lighters, has given this disposable ignition device a renaissance. Plumes of watermelon matcha mist may be choking our lungs today, but humanity will never lose its taste for the simple pleasure of playing with fire.",
		effect: "Ignites a fire in Arson.",
		requirement: "",
		type: "Tool",
		weapon_type: null,
		buy_price: 5,
		...
		market_value: 2571,
		circulation: 1066010,
		image: "https://www.torn.com/images/items/1466/large.png",
		tradeable: true,
	},
	1467: {
		name: "Withered M'aol Tentacle",
		description:
			"Though the immortal beast M'aol cannot be truly slain, those daring enough to shatter his mortal shell would be wise to claim a tentacle as a trophy. The unstable nature of M'aol's material form disrupts reality around it, uneasy with its existence in the physical realm. Thus, ownership of the loam-dweller's twitching appendage bestows phenomenal restorative powers upon its bearer—an invigorated zest for life, unbridled energy, overwhelming joy, and the fearless courage known only to the foolhardy.\n<br/><br/>\nNow little more than a husk, the tentacle lies powerless, its once-vital essence long since spent.",
		effect: "",
		requirement: "",
		type: "Collectible",
		weapon_type: null,
		...
		market_value: 0,
		circulation: 1,
		image: "https://www.torn.com/images/items/1467/large.png",
		tradeable: true,
	},
	1468: {
		name: "Withered Ladso Eye",
		description:
			"The all-seeing noctis of the barbarian fiend Lad'so gazes upon matters past, affairs of the present, and future happenings as if they were one and the same. Once wrenched from its owner's socket, this grotesque artifact grants unfathomable hindsight, with those who possess it able to absorb familiar literary tomes as if reading them for the first time, uncovering insights hitherto untapped within the texts\n<br/><br/>\nAlas, that clarity has since faded, the eye now little more than a relic, its piercing vision forever extinguished.",
		effect: "",
		requirement: "",
		type: "Collectible",
		weapon_type: null,
		...
		market_value: 0,
		circulation: 1,
		image: "https://www.torn.com/images/items/1468/large.png",
		tradeable: true,
	},
	1469: {
		name: "Withered Sylo Tooth",
		description:
			"While the outstretched limbs of the wretched Sylo'nadam inflict grievous harm, it is the creature's tooth, not its serrapaw, that holds true significance among those who best him in battle. This abomination's fangs are imbued with an uncanny sensitivity to the world. Possession of but one said to sharpen the focus of those who wield them, elevating their precision and lethality to new heights.\n<br/><br/>\nStripped of its potency, the fang sits brittle and spent, a moldering curio destined for a collector's drawer.",
		effect: "",
		requirement: "",
		type: "Collectible",
		weapon_type: null,
		...
		market_value: 0,
		circulation: 1,
		image: "https://www.torn.com/images/items/1469/large.png",
		tradeable: true,
	},
	1470: {
		name: "Withered Dyno Sac",
		description:
			"On the rare occasion that Dyno'salam is defeated, conquerors vie for the right to plunge their fists deep into its cavernous, razor-lined cleft. Those who reach far enough may seize the most coveted prize—the aortal sac. This peculiar organ, with its intricate ventricular arrangement, is the closest thing to a heart this beast possesses. When owned by a mortal, the sac forges an ethereal symbiosis with its holder, purifying their essence to negate the unwanted influences of mind-altering substances.\n<br/><br/>\nLo, what once pulsed with otherworldly accord now lies deflated, its effects having worn off long ago.",
		effect: "",
		requirement: "",
		type: "Collectible",
		weapon_type: null,
		...
		market_value: 0,
		circulation: 1,
		image: "https://www.torn.com/images/items/1470/large.png",
		tradeable: true,
	},
	1471: {
		name: "Withered Nol Cloachra",
		description:
			"The putrid, bubbling cloachra of Nol'dasaym is often overlooked among the spoils of battle. Yet, only a fool would discard such a valuable treasure, unsettling though it may be. In life, Nol's cloachra functions as an exit and entry point for nutrients, waste, and reproductive fluids. Upon the creature's demise, a bewildering phenomenon occurs: its bearer can imbibe consumables without actually consuming them. As such, this grotesque artifact is a prize among prizes, for never again need its owner frequent a bazaar for essential supplies.\n<br/><br/>\nBereft of its foul enchantment, the cloachra's withered variant festers without function, a spent oddity reduced to the status of an ornament.\n",
		effect: "",
		requirement: "",
		type: "Collectible",
		weapon_type: null,
		...
		market_value: 0,
		circulation: 1,
		image: "https://www.torn.com/images/items/1471/large.png",
		tradeable: true,
	},
	1472: {
		name: "Withered Asmol Knuckle",
		description:
			"Carved directly from the titanfist of the colossal Asmol'yand, this formidable appendage initially seems too burdensome to carry. However, should one persist by shouldering this grotesque burden from the battlefield, immense destructive power shall be conferred upon them. Enemies that once proved taxing are effortlessly crushed, with the bearer able to infuse each strike with raw, elemental force for twice the usual effect.\n<br/><br/>\nUntil, that is, the bewitched knuckle fractured, its force drained, rendering it no more than a wretched paperweight.",
		effect: "",
		requirement: "",
		type: "Collectible",
		weapon_type: null,
		...
		market_value: 0,
		circulation: 1,
		image: "https://www.torn.com/images/items/1472/large.png",
		tradeable: true,
	},
	1473: {
		name: "Chicago Shot Glass '25",
		description:
			"The slosh of liquid in this limited edition TornCon 2025 shot glass sounds just like Raelyn and MESMERlZED tipping their kayak in the Chicago river. The yells of the tour boat staff at them to get out of the way were a stark contrast to Chedburn mumbling his way through Rammstein with the only German in the group, Alex_I_von_St. A shot may warm your stomach, but can't quite warm your heart like the memories made swimming in Lake Michigan, eating deep dish pizza and buying cheap alcohol at the convenience store to drink on the hotel lawn until the sprinklers went off at 2am. We all made mistakes, but none bigger than staff fedding Chedburn - twice. From Torn goodie bags to city tours, we had one heck of a time. Capone would be rolling in his grave over the crime obsessed tourists taking over Chicago, but this souvenir will remind you of the highlights during this trip forever.",
		effect: "",
		requirement: "",
		type: "Collectible",
		weapon_type: null,
		...
		market_value: 0,
		circulation: 100,
		image: "https://www.torn.com/images/items/1473/large.png",
		tradeable: true,
	},
	1474: {
		name: "Lesser Arca Fortunae",
		description:
			"Cast aside upon the defeat of interdimensional beings, the Lesser Arca Fortunae is a curious vessel. Though humbler than its Greater counterpart, its contents are far from trifling. Those who breach its ornate exterior shall discover treasure set in scores, a fortune of desirable items gathered as if to lure mortals toward the promise of something greater.",
		effect: "Provides a small number of Halloween treats when opened.",
		requirement: "",
		type: "Supply Pack",
		weapon_type: null,
		buy_price: 0,
		...
		market_value: 0,
		circulation: 2694,
		image: "https://www.torn.com/images/items/1474/large.png",
		tradeable: false,
	},
	1475: {
		name: "Scream Mask '25",
		...
		market_value: 0,
		circulation: 250,
		image: "https://www.torn.com/images/items/1475/large.png",
		tradeable: true,
	},
	1476: {
		name: "Kelsie's Keepsake",
		description:
			"If you ever received a helping hand during your first days in Torn, it probably came from Kelsie. A former staffer with a soft spot for greenleafs, she’s spent years helping newbies with giveaways and care packages. Indeed, her dollar-a-day private island rentals mean she’s regarded as the only good landlord Torn (or the world) has ever known. Kelsie’s experience leading Forged Through War also inspired her to write countless guides, including a guide to the guides, because sometimes you really do need a guide to guide you through all those guides. Her obsession with preserved goods inspired her keepsake, a care package wrapped in pickle paper. And thanks to her kindness, countless n00bs have avoided finding themselves in a pickle of their own.",
		effect: "",
		requirement: "",
		type: "Collectible",
		weapon_type: null,
		...
		market_value: 0,
		circulation: 250,
		image: "https://www.torn.com/images/items/1476/large.png",
		tradeable: true,
	},
	1477: {
		name: "Ana's Keepsake",
		description:
			"The TCX-59 pathological agent has an antidote, but there is no known cure for the virus known as Ana. The Plague of the Forums™, her talents include causing drama, excessive boasting, and sinking her claws into Torn’s most powerful men. Gríma Wormtongue in lipstick, she brought Iron Fist’s Rifty to ruin in a murky web of blackmail and scams. In real life, Ana’s claims to have a military background have drawn scrutiny, but in-game she commands an army of simps loyal to her every tantrum. She threatens to quit Torn with every second breath, but always finds a reason to stay, usually in the pockets of her latest benefactor. Ana's keepsake, a luxury car disguised as a military vehicle, reflects her perfectly: loud, expensive, and far from combat ready.",
		effect: "",
		requirement: "",
		type: "Collectible",
		weapon_type: null,
		...
		market_value: 0,
		circulation: 250,
		image: "https://www.torn.com/images/items/1477/large.png",
		tradeable: true,
	},
	1478: {
		name: "Midknight's Keepsake",
		description:
			"Midknight is the long-time leader of Subversive Alliance, one of Torn’s most influential factions. He commands respect on the battlefield, once enduring three Dirty Bombs in a single day, but his greatest drama unfolded while on the committee, when Midknight sent an unreleased mission item to a friend who promptly auctioned it off. His innocence was proclaimed, but the Community Manager Marc fedded him, sparking a firestorm of debate which ended with his release and Marc's resignation. Upon his return, Midknight raised billions in a begging campaign, before comparing himself to Nelson Mandela in an interview with the TCT. Midknight’s keepsake honors his escape from federal jail, along with Subversive Alliance’s irritating obsession with barbecue cookouts.",
		effect: "",
		requirement: "",
		type: "Collectible",
		weapon_type: null,
		...
		market_value: 0,
		circulation: 250,
		image: "https://www.torn.com/images/items/1478/large.png",
		tradeable: true,
	},
	1479: {
		name: "Evaline's Keepsake",
		description:
			"Trying to get Torn players to leave the house is no mean feat, so for Evaline to have lured them across the globe is a damn miracle. TornCon began as an intimate dinner with Andyman after her other guests let her down. Undeterred, the ever-positive Evaline kept at it, growing the event to the hundredfold gatherings we see today. She later divorced her napkin-addicted spouse to marry Torn’s founder, Chedburn, in 2025, after her overtures to Duke were rejected. This was all in-game, of course, with her real-life spouse 0rganicmechanic often accompanying her to TornCon in a pair of fetching cargo shorts. Evaline’s pristine hosting abilities earned TornCon official recognition in 2023, with the event now serving as an annual reminder that Torn players can, in fact, touch grass.",
		effect: "",
		requirement: "",
		type: "Collectible",
		weapon_type: null,
		...
		circulation: 250,
		image: "https://www.torn.com/images/items/1479/large.png",
		tradeable: true,
	},
	1480: {
		name: "Omanpx's Keepsake",
		description:
			"If Torn had its own census bureau, data-driven Omanpx would be running it. He’s the go-to guy if you want to know who dominated Halloween, which faction led the assault on the Island, or why one group somehow owns every PSF in existence. His data dumps and analysis are popular even with non-nerds, his custom spreadsheets and bots improving many people's gameplay. Omanpx also founded Chedslist, Torn’s version of Craigslist, tracked multis with various tools—hence his multi-tool keepsake—and maintained the fedded archives in CRLF’s stead. He’s one of those players who makes everyone’s game better simply by doing what he loves. Give Omanpx your API keys and he’ll hand you the keys to the city.",
		effect: "",
		requirement: "",
		type: "Collectible",
		weapon_type: null,
		buy_price: 0,
		sell_price: 0,
		market_value: 189997997,
		circulation: 250,
		image: "https://www.torn.com/images/items/1480/large.png",
		tradeable: true,
	},
	1481: {
		name: "Locked's Keepsake",
		description:
			"33257, better known as Locked, joined Torn in its first year and was one of our earliest admins, with the Locked Teddy collectible made to honor his contributions. Locked earned his name from keeping the forums in line and was an early community organizer, credited with setting up the first faction buying and selling thread. His time in power ended abruptly after he gifted himself items and secretly inflated his stats, a scandal that also deposed his spouse Aethwynn, Torn’s first Community Manager. It’s rumoured his stats were later reset, turning Locked into a high-level punchbag. For that reason, Locked found himself added to everyone’s enemy list after being named in various guides as a levelling target, ensuring that while his authority faded, his usefulness to the playerbase endured.",
		effect: "",
		requirement: "",
		type: "Collectible",
		weapon_type: null,
		buy_price: 0,
		sell_price: 0,
		market_value: 200000001,
		circulation: 250,
		image: "https://www.torn.com/images/items/1481/large.png",
		tradeable: true,
	},
	1482: {
		name: "Bearer Bond",
		...
		market_value: 87901,
		circulation: 54251,
		image: "https://www.torn.com/images/items/1482/large.png",
		tradeable: true,
	},
	1483: {
		name: "Insulin",
		description:
			"Insulin was discovered in 1921 by Banting and Best in Toronto, Canada, who sold the patent to the University of Toronto for one measly dollar as their gift to the world. Today, the United States bleeds uninsured diabetics dry with extortionate insulin prices, while Canada sells the same life-saving drug for a fraction of the cost. F**king socialists, eh? With Torn producing no insulin of its own, smugglers are left to meet local demand, importing large coolers of this life-saving drug to keep the city’s pharmacy stocked. And if some of these supplies end up being sold to fat Americans at an even fatter profit, that’s all the sweeter.",
		effect: "",
		requirement: "",
		type: "Other",
		weapon_type: null,
		...
		market_value: 10080,
		circulation: 266257,
		image: "https://www.torn.com/images/items/1483/large.png",
		tradeable: true,
	},
	1484: {
		name: "Bear Gall",
		description:
			"Dried bear gallbladders have been popular among traditional Chinese healers for over 1,000 years, with these items storing rich, potent bile in quantities the Politics & Law forum could only dream of. Demand for bear bile fuels the notorious practice of bear bile farming, where bears are kept in captivity and bile is extracted repeatedly through catheters or open wounds. On the scale of shitty things to do, slaughtering a bear and removing its gallbladder is probably the kinder option, but Dr. Doolittle, you ain’t. This particular dried gall was taken from a Canadian bear, meaning it likely apologized as it was being slit open and thanked the hunter for leaving its kidneys intact.",
		effect: "",
		requirement: "",
		type: "Other",
		weapon_type: null,
		...
		market_value: 34793,
		circulation: 87516,
		image: "https://www.torn.com/images/items/1484/large.png",
		tradeable: true,
	},
	1485: {
		name: "Shark Fin",
		...
		market_value: 65618,
		circulation: 203094,
		image: "https://www.torn.com/images/items/1485/large.png",
		tradeable: true,
	},
	1486: {
		name: "Turtle Shell",
		description:
			"The Hawksbill Sea Turtle is a critically endangered ocean reptile, with only around 8,000 nesting females left in the wild. A shame, really, since their shells make such striking jewelry. Nothing goes to waste when one is carved up either: their various parts are said to taste of beef, chicken, or fish, depending on which bit you’re eating. With such a succulent range of meats on offer, now you know why April O’Neill preferred the company of those teenage mutant ninja lads.",
		effect: "",
		requirement: "",
		type: "Other",
		weapon_type: null,
		...
		market_value: 97495,
		circulation: 80954,
		image: "https://www.torn.com/images/items/1486/large.png",
		tradeable: true,
	},
	1487: {
	...
	1488: {
		...
		market_value: 502164,
		circulation: 43381,
		image: "https://www.torn.com/images/items/1488/large.png",
		tradeable: true,
	},
	1489: {
		name: "Ephedrine Powder",
		description:
			"Ephedrine powder is a stimulant alkaloid, once plucked from Ephedra plants and now created synthetically. It’s the chemical cousin of epinephrine, the body’s own fight-or-flight hormone, and hits many of the same buttons when ingested, giving you a faster heartbeat, higher blood pressure, and wider airways. Doctors used to hand it out as a decongestant and bronchodilator back when old-timey meds were cool. These days ephedrine powder is used in the production of methamphetamines, which is why its distribution is tightly controlled. The easiest way to import it back from Switzerland is to hide several containers inside one of those giant Toblerones you can buy at the airport. The chocolate can then be eaten slowly, sensually, in a bathroom stall as a pre-flight treat.",
		effect: "",
		requirement: "",
		type: "Other",
		weapon_type: null,
		...
		market_value: 26901,
		circulation: 471003,
		image: "https://www.torn.com/images/items/1489/large.png",
		tradeable: true,
	},
	1490: {
		name: "Safrole Oil",
		...
		market_value: 16011,
		circulation: 386048,
		image: "https://www.torn.com/images/items/1490/large.png",
		tradeable: true,
	},
	1491: {
		name: "Ergotamine Ampoule",
		description:
			"Ergotamine is an alkaloid originally isolated from ergot, the rye fungus that once gave medieval villagers some very colourful hallucinations. In the early 20th century, ampoules of ergotamine were prescribed to migraine sufferers, replacing earlier cures like vibrators, urine compresses, or a massive hole drilled in the top of your skull. Ergotamine also happens to be a key ingredient in the production of LSD, which itself is a great reliever of migraines, since it’s hard to have a headache when your skull has dissolved into a fluffy purple cloud of unicorn farts.",
		effect: "",
		requirement: "",
		type: "Other",
		weapon_type: null,
		...
		market_value: 19922,
		circulation: 533241,
		image: "https://www.torn.com/images/items/1491/large.png",
		tradeable: true,
	},
	1492: {
		name: "Counterfeit Manga",
		description:
			"Manga can be traced as far back as the 12th century, when ancient Japanese artists depicted monkeys as sexually adventurous schoolgirls with giant eyes and massive breasts. Modern manga, shaped by Hokusai in the 1800s and Osamu Tezuka in the 20th century, became the glossy serialised epics sold today. This particular comic series is a counterfeit copy of a famous story involving a depressed, overworked businessman whose attempts at ritual suicide are consistently thwarted by his inability to grasp a sword with his tentacles.",
		effect: "",
		requirement: "",
		type: "Other",
		weapon_type: null,
		...
		market_value: 69694,
		circulation: 126826,
		image: "https://www.torn.com/images/items/1492/large.png",
		tradeable: true,
	},
	1493: {
		name: "Whale Meat",
		description:
			"Whale meat has been eaten for centuries in places like Japan, Norway, and Iceland, and still is today, despite protests from conservationists and the whales themselves. Many westerners hold a moral objection to the practice thanks to documentaries such as Free Willy, which depicted whales as social companions rather than the delicious hunks of sea ham they actually are. The truth is that most whale meat is consumed for traditional or political reasons. These chewy chops of fishy beef are notoriously high in mercury, excessive consumption of which has been known to cause memory loss, loss of memory, huge stupid bastard idiot mood swings, an inability to remember things, po3or ha33dn eeye31 coor6dinati00on, and memory loss.",
		effect: "",
		requirement: "",
		type: "Other",
		weapon_type: null,
		...
		market_value: 39651,
		circulation: 119796,
		image: "https://www.torn.com/images/items/1493/large.png",
		tradeable: true,
	},
	1494: {
		...
		market_value: 203534,
		circulation: 110836,
		image: "https://www.torn.com/images/items/1494/large.png",
		tradeable: true,
	},
	1495: {
		name: "Ambergris Lump",
		description:
			"Ambergris, not to be confused with hamburgers, is a waxy greyish substance created inside the intestines of sperm whales. Formed from a fatty secretion, it’s expelled either orally or anally before drifting ashore on beaches worldwide. Thanks to its use in perfume making, a single lump of this fat shitty whale barf can fetch hundreds of thousands of dollars. Because it comes from sperm whales, an endangered species, the ambergris trade is banned in many countries under whaling protection laws. The only ways around this are to buy it on the black market or obtain ambergris naturally, by finding it on a beach or sticking your fingers down a whale’s throat.",
		effect: "",
		requirement: "",
		type: "Other",
		weapon_type: null,
		...
		market_value: 430012,
		circulation: 18439,
		image: "https://www.torn.com/images/items/1495/large.png",
		tradeable: true,
	},
	1496: {
		name: "Natural Pearls",
		...
		market_value: 149239,
		circulation: 61366,
		image: "https://www.torn.com/images/items/1496/large.png",
		tradeable: true,
	},
	1497: {
		name: "Uncut Diamonds",
		...
		market_value: 240091,
		circulation: 93080,
		image: "https://www.torn.com/images/items/1497/large.png",
		tradeable: true,
	},
	1498: {
		name: "Tiger Bone Powder",
		description:
		...
		market_value: 69768,
		circulation: 49077,
		image: "https://www.torn.com/images/items/1498/large.png",
		tradeable: true,
	},
	1499: {
		name: "Obsidian Point",
		...
		market_value: 112322,
		circulation: 51870,
		image: "https://www.torn.com/images/items/1499/large.png",
		tradeable: true,
	},
	1500: {
		name: "Quartzite Point",
		description:
			"Quartzite is a hard metamorphic rock formed when sandstone is compressed and heated deep underground by Jamiroquai or tectonic forces. Typically pale and speckled with tightly fused quartz grains, a quartzite arrowhead has a gritty, crystalline sheen that catches the light. Early Homo sapiens in what is now South Africa fashioned it into hand axes, scrapers, and projectile points, but today quartzite is used for more peaceful purposes like making kitchen countertops. South Africa’s Table Mountain contains an abundance of quartzite, enough that you could theoretically clad the entire summit in a single massive countertop at an estimated cost of around $1.1 billion USD—$1 billion flat if you're willing to pay cash in hand.",
		effect: "",
		requirement: "",
		type: "Artifact",
		weapon_type: null,
		...
		market_value: 181786,
		circulation: 46570,
		image: "https://www.torn.com/images/items/1500/large.png",
		tradeable: true,
	},
	1501: {
		name: "Chert Point",
		...
		market_value: 139434,
		circulation: 47885,
		image: "https://www.torn.com/images/items/1501/large.png",
		tradeable: true,
	},
	1502: {
		name: "Basalt Point",
		...
		market_value: 116847,
		circulation: 45869,
		image: "https://www.torn.com/images/items/1502/large.png",
		tradeable: true,
	},
	1503: {
		name: "Chalcedony Point",
		description:
			"Chalcedony is a microcrystalline form of quartz formed when silica-rich fluids seep into rock cavities and solidify. The Patagonian region of Argentina is rich in chalcedony, with native prehistoric cultures using it to make knives, scrapers, and arrowheads. This material, which ranges in colour from white and blue to pinky reds, is easy to knap and its edges stay sharp longer than rival materials like obsidian. On the 22nd of June 1986, Diego Maradona scored a goal with his hand in the World Cup quarter-final against England. The cheating little shit would never have managed that if someone had fired a chalcedony point through his head in the 50th minute.",
		effect: "",
		requirement: "",
		type: "Artifact",
		weapon_type: null,
		...
		market_value: 134428,
		circulation: 45870,
		image: "https://www.torn.com/images/items/1503/large.png",
		tradeable: true,
	},
	1504: {
		name: "Quartz Point",
		...
		market_value: 140743,
		circulation: 48870,
		image: "https://www.torn.com/images/items/1504/large.png",
		tradeable: true,
	},
	1505: {
		name: "Evil Christmas Gonk",
		description:
			"A festive gonk with a HATEFUL soul and a sack full of bad intentions. It WATCHES from the shelf and WAITS for joy to turn to agony. He SEES your sins and COVETS your tears. Nobody remembers buying this THING. And yet... IT persists.",
		effect: "",
		requirement: "",
		type: "Collectible",
		weapon_type: null,
		...
		market_value: 0,
		circulation: 1000,
		image: "https://www.torn.com/images/items/1505/large.png",
		tradeable: true,
	},
	1506: {
		name: "Copium Inhaler",
		description:
			"Copium is a mood stabilizing gas which allows the user to gain large quantities of self-belief when inhaled. Known on the street as Hot Air, C?P?U? is self-administered during the closing stages of a directionless rant directed at an unpaid volunteer who is almost certainly correct. Each pressurized canister has been recovered from the inventory of a detained player who did nothing wrong, besides harass those women, use “that” word, and share the family computer with their fifteen brothers. Prolonged use may result in wilful blindness, tone deafness, and selective memory loss.",
		effect: "Increases hubris by 10% over 180 minutes.\nIncludes side effects (delusion).",
		requirement: "",
		type: "Special",
		weapon_type: null,
		buy_price: 0,
		...
		market_value: 0,
		circulation: 40,
		image: "https://www.torn.com/images/items/1506/large.png",
		tradeable: true,
	},
	1507: {
		name: "Snowman Mask '25",
		description:
			"Have you ever wanted to look like a snowman without suffering the consequences of severe hypothermia and frostbite? Why? What would doing this actually achieve? Would briefly looking like a snowman make you feel good about yourself? Would it right all those wrongs in that pathetic existence you call a life? Would it actually, though? Seriously? Then strap on this somewhat realistic-looking snowman mask! Made from lightweight polystyrene and charmingly adorned with white asbestos, this mask is all you need for the holiday season. Beside a loving family and friends, of course. ",
		effect: "",
		requirement: "",
		type: "Clothing",
		weapon_type: null,
		...
		market_value: 0,
		circulation: 250,
		image: "https://www.torn.com/images/items/1507/large.png",
		tradeable: true,
	},
	1509: {
		name: "Angle Grinder",
		description:
			"The angle grinder is a power tool beloved by DIY professionals and weekend amateurs who aren't too attached to their fingers, or at least soon won't be. This compact handheld cutter relies on an abrasive, resin-bonded disc which spins at high speed to cut through metal, glass, bone, and flesh. This particular model was purchased in bulk off Temu, which means the safety guard is decorative, the off switch is more of a suggestion, and the ten-year warranty is valid only if used between the hours of 8:30 and 8:35 in a small conurbation on the outskirts of Dongguan.",
		effect: "",
		requirement: "",
		type: "Tool",
		weapon_type: null,
		buy_price: 0,
		sell_price: 0,
		market_value: 2261871,
		circulation: 10504,
		image: "https://www.torn.com/images/items/1509/large.png",
		tradeable: true,
	},
} as const;
