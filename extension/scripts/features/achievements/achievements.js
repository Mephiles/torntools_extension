const ACHIEVEMENTS = [
	...
	{ name: "Argentina", stats: () => userdata.personalstats.travel.argentina, detection: { keyword: "argentina" }, requirements: { pages: ["travelagency"] } },
	{ name: "Canada", stats: () => userdata.personalstats.travel.canada, detection: { keyword: "canada" }, requirements: { pages: ["travelagency"] } },
	{ name: "Caymans", stats: () => userdata.personalstats.travel.cayman_islands, detection: { keyword: "cayman" }, requirements: { pages: ["travelagency"] } },
	{ name: "China", stats: () => userdata.personalstats.travel.china, detection: { keyword: "china" }, requirements: { pages: ["travelagency"] } },
	{
		name: "UAE",
	...
	{ name: "Hawaii", stats: () => userdata.personalstats.travel.hawaii, detection: { keyword: "hawaii" }, requirements: { pages: ["travelagency"] } },
	{ name: "Japan", stats: () => userdata.personalstats.travel.japan, detection: { keyword: "japan" }, requirements: { pages: ["travelagency"] } },
	{ name: "UK", stats: () => userdata.personalstats.travel.united_kingdom, detection: { keyword: "kingdom" }, requirements: { pages: ["travelagency"] } },
	{ name: "Mexico", stats: () => userdata.personalstats.travel.mexico, detection: { keyword: "mexico" }, requirements: { pages: ["travelagency"] } },
	{
		name: "South Africa",
