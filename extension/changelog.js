export default [
	{
		...
		logs: {
			...
			changes: [
				{ message: "Rewrite core system.", contributor: "DeKleineKobini" },
				{ message: "Improve update notice so it only shows when another version was installed.", contributor: "DeKleineKobini" },
				{ message: "Prevent Zalgo overflow instead of fully replacing it.", contributor: "DeKleineKobini" },
	...
	},
	{
		...
		logs: {
			fixes: [
				{ message: "Fix Achievement check by including medals/honors.", contributor: "finally" },
				{ message: "Fix 'Three-peat' mission hint.", contributor: "smikula" },
	...
	},
	{
		...
		logs: {
			...
			fixes: [
				...
				{ message: "Fix chain notifications going out too early.", contributor: "DeKleineKobini" },
				{ message: "Fix icon margin on dynamic change.", contributor: "finally" },
	...
	},
	{
		...
		logs: {
			features: [
				{ message: "Remove zalgo text from chat.", contributor: "DeKleineKobini" },
				{ message: "Add specials info on company pages.", contributor: "Mephiles" },
				{ message: "Highlight energy and nerve when their respective refills haven't been used yet.", contributor: "DeKleineKobini" },
				{ message: "On the item market, highlight items under their market value.", contributor: "DeKleineKobini" },
			...
			fixes: [
				...
				{ message: "Fix settings messages.", contributor: "DeKleineKobini" },
				{ message: "Fix target table when there are no targets.", contributor: "DeKleineKobini" },
				{ message: "Fix multiple mission hints.", contributor: "DeKleineKobini" },
				{ message: "Fix missions for the Anonymous agent.", contributor: "DeKleineKobini" },
				{ message: "Fix mission hints not showing when changing agents, accepting or completing a mission.", contributor: "DeKleineKobini" },
				{ message: "Fix the demo automatically opening and the markings when changing your api key on the API page.", contributor: "DeKleineKobini" },
			...
			changes: [
				...
				{ message: "Add an option to only show stats estimates under a certain level.", contributor: "DeKleineKobini" },
				{ message: "Improve missing mission information message.", contributor: "DeKleineKobini" },
	...
	},
	{
		...
		logs: {
			features: [
				...
				{ message: "Show stat requirements for specialty gyms.", contributor: "DeKleineKobini" },
				{ message: "Add a button to open chat in trades.", contributor: "DeKleineKobini" },
				{ message: "Show individual price of an sold item or share on the event page on hover.", contributor: "DeKleineKobini" },
				{ message: "Make energy and nerve clickable to open their respective pages.", contributor: "Mephiles" },
				{ message: "Add Landing time to Travel page.", contributor: "Mephiles" },
				{ message: "Show mission hints and tips.", contributor: "DeKleineKobini" },
			...
			fixes: [
				...
				{ message: "Fix achievements update time showing wrong time.", contributor: "Mephiles" },
				{ message: "Always show Recommended NNB in the right table.", contributor: "DeKleineKobini" },
				{ message: "Fix showing item value (which also broke max buy and YATA updating).", contributor: "DeKleineKobini" },
				{ message: "Hide item highlighting when closing the container if the setting is enabled.", contributor: "DeKleineKobini" },
				{ message: "Fix advanced OC information not showing after starting and replanning an OC.", contributor: "DeKleineKobini" },
			...
			changes: [
				...
				{ message: "Update the profile view to not completely fail upon any api error.", contributor: "DeKleineKobini" },
				{ message: "Sync the 15 minute updater to the stock ticks.", contributor: "DeKleineKobini" },
				{ message: "Ignore punctuation marks for word highlighting.", contributor: "DeKleineKobini" },
				{ message: "Include money value and stocks in trade value.", contributor: "DeKleineKobini" },
				{ message: "Add a way to ignore cash on hand for max buy in bazaar.", contributor: "DeKleineKobini" },
				{ message: "Include a link to the OC in the information window.", contributor: "Mephiles" },
				{ message: "Allow import and export via text.", contributor: "Mephiles" },
				{ message: "Add more special filters for factions, search and overseas.", contributor: "Mephiles" },
				{ message: "Only allow usable items to be added to Quick Items.", contributor: "DeKleineKobini" },
				{ message: "Reduce API fetches to reduce stress on API servers. Split userdata to Essential and Basic.", contributor: "Mephiles" },
				{ message: "Shorten some mission numbers even more to let it fit the box.", contributor: "DeKleineKobini" },
				{ message: "Remove links from Achievement cells.", contributor: "Mephiles" },
				{ message: "Adjust minimal 'show more'-button height on profiles.", contributor: "DeKleineKobini" },
				{ message: "Show illegal product crimes achievements.", contributor: "DeKleineKobini" },
				...
				{ message: "Add a limit to flying items.", contributor: "DeKleineKobini" },
				{ message: "Add link to target on target page.", contributor: "DeKleineKobini" },
	...
	},
	{
		...
		logs: {
			features: [
				{ message: "Add OC timer to Information window", contributor: "Mephiles" },
				{ message: "Add Chain timer notification", contributor: "Mephiles" },
				{ message: "Add New Day notification", contributor: "Mephiles" },
				{ message: "Add highlighting for your own OC", contributor: "DeKleineKobini" },
				{ message: "Add option to hide Areas links", contributor: "Mephiles" },
			...
			changes: [
				...
				{ message: "Add option to display your own vault value in Information window (indicated by *)", contributor: "Mephiles" },
				{ message: "Make Travel Destinations table available while flying", contributor: "Mephiles" },
				{ message: "Add Data usage estimate on Firefox", contributor: "DeKleineKobini" },
				{ message: "Allow whole numbers and percentages simultaneously for bar Notifications", contributor: "Mephiles" },
				{ message: "Change userdata fetch from 15sec to 30sec to cut down on unnecessary API calls", contributor: "Mephiles" },
				{ message: "Set 'Force TornTools' setting as default", contributor: "DeKleineKobini" },
				{ message: "Make Travel Table update automatically", contributor: "DeKleineKobini" },
				{ message: "Change 'Hide chats' icon", contributor: "DeKleineKobini" },
				{ message: "Recode Settings page logic", contributor: "Mephiles" },
				{ message: "Rework how Importing/Exporting works", contributor: "Mephiles" },
				{ message: "Disable Item Market links on Mobile view", contributor: "Mephiles" },
				{ message: "Add option to display relative values on Profile Stats", contributor: "Mephiles" },
				{ message: "Add sorting capability for Profile chosen stats", contributor: "Mephiles" },
	...
	},
	{
		...
		logs: {
			...
			fixes: [
				...
				{ message: "Fix the buy max abroad to take already bought items into account", contributor: "DeKleineKobini" },
				{ message: "Format rehab cost as currency", contributor: "DeKleineKobini" },
				{ message: "Fix gym hiding not working after switching to another gym", contributor: "DeKleineKobini" },
				...
				{ message: "Fix Achievements' tooltip appearing at the bottom of the page", contributor: "Mephiles" },
				{ message: "Fix Faction announcement 'full page' option not loading when Chain tab was open", contributor: "Mephiles" },
				{ message: "Fix Faction armory filter not loading for Mobile", contributor: "Mephiles" },
				{ message: "Block Quick Items doubles", contributor: "DeKleineKobini" },
				{ message: "Fix Quick Items item dragging", contributor: "DeKleineKobini" },
				{ message: "Adjust Profile script to Torn's layout changes", contributor: "DeKleineKobini" },
			...
			changes: [
				...
				{ message: "Make Networth fetching regular (10min interval)", contributor: "Mephiles" },
				{ message: "Redesign Achievements' tooltip", contributor: "Mephiles" },
	...
	},
	{
		...
		logs: {
			features: [
				{ message: "Added Vault balance to Torn Information window", contributor: "Mephiles" },
				{ message: "Added option to disable individual Gym stats training", contributor: "Mephiles" },
				{ message: "Added Item Market links to Items", contributor: "Mephiles" },
			...
			fixes: [
				...
				{ message: "Enabled Update TornStats button on mobile Gym page", contributor: "Mephiles" },
				{ message: "Fixed displaying Faction Member info when honors are turned off", contributor: "Mephiles" },
				{
					message:
				...
				{ message: "Removed duplicates from Profile Stats", contributor: "Mephiles" },
				{ message: "Fixed Market Tab searching", contributor: "DeKleineKobini" },
				{ message: "Fixed OC Recommended NNB display when DoctorN is enabled", contributor: "DeKleineKobini" },
				{ message: "Fixed Gym Estimated Energy script when unlocking the last gym", contributor: "Mephiles" },
				{ message: "Fixed Mobile content overflow", contributor: "Mephiles" },
				{ message: "Fixed search bug in Stocks popup", contributor: "Mephiles" },
				{ message: "Fixed Firefox notification links not working", contributor: "Mephiles" },
				{ message: "Fixed chain timer inaccuracy in Info popup", contributor: "Mephiles" },
				{ message: "Removed an extra HR from Clean travel page", contributor: "Mephiles" },
				{ message: "Fixed Gym script failing to load completely when All gyms were unlocked", contributor: "Mephiles" },
			...
			changes: [
				...
				{ message: "Improved TornTools containers' design", contributor: "Mephiles" },
				{ message: "Containers now remember their last position", contributor: "Mephiles" },
				{ message: "Added alternative way of adding Quick Crimes & Items in case dragging fails to work", contributor: "Mephiles" },
				{ message: "Made Navigation Bar TornTools sections collapsible", contributor: "Mephiles" },
				{ message: "Added EDIT button to add/remove Profile Stats to eliminate accidental moving", contributor: "Mephiles" },
				{ message: "Removed Text-To-Speech from permissions (still usable)", contributor: "Mephiles" },
	...
	},
	{
		...
		logs: {
			features: [
				{ message: "Added detailed info about Drugs on Items page & Faction armory", contributor: "Mephiles" },
				{ message: "Added option to display full Announcements & Info containers on Faction page", contributor: "Mephiles" },
				{ message: "Added option to enable Text-To-Speech for notifications", contributor: "Mephiles" },
				{ message: "Added option to show Bazaar Value", contributor: "Mephiles" },
				{ message: "Added option to show Faction Armory Value (does not take into count Cesium)", contributor: "Mephiles" },
				{ message: "Added option to clean Flight page", contributor: "Mephiles" },
				{ message: "Added option to show 'respect to go' info for Faction Upgrades", contributor: "Mephiles" },
				{ message: "Added item highlighting when going from Item Market to someone's Bazaar", contributor: "Mephiles" },
			...
			fixes: [
				...
				{ message: "Fixed Info popup failing for Firefox when Traveling", contributor: "Mephiles" },
				{ message: "Fixed OCs opening when their status was not Ready", contributor: "Mephiles" },
				{ message: "Fixed Info popup failing to load when no booster cooldown", contributor: "Mephiles" },
				{ message: "Fixed notifications repeating after 15 minutes. Changed time to 24 hours", contributor: "Mephiles" },
				{ message: "Fixed empty space on Mobile while Traveling", contributor: "Mephiles" },
				{ message: "Fixed events and message Notifications not respecting preferences", contributor: "Mephiles" },
				{ message: "Fixed script info stacking on Faction Crimes page", contributor: "Mephiles" },
				{ message: "Fixed 12hour formatting showing time as 00:30 AM rather than 12:30 AM", contributor: "Mephiles" },
			...
			changes: [
				...
				{ message: "Split up API settings", contributor: "Mephiles" },
	...
	},
	{
		...
		logs: {
			discord: [{ message: "Join the Discord (https://discord.gg/ukyK6f6) to report bugs, give suggestions or just chat", contributor: "Mephiles" }],
			features: [
			...
			fixes: [
				...
				{ message: "Fixed TornStats integration not working on Firefox", contributor: "Mephiles" },
				{
					message:
			...
			mobile: [
				...
				{ message: "Disabled Notes section for mobile", contributor: "Mephiles" },
				{ message: "Fixed Effective Battle Stats table for mobile", contributor: "Mephiles" },
				{ message: "Disabled Achievements for mobile", contributor: "Mephiles" },
				{ message: "Disabled Gym Graph on mobile", contributor: "Mephiles" },
	...
	},
	{
		...
		logs: {
			...
			changes: [
				...
				{ message: "Shop fill max takes into count the 100 item limit", contributor: "Mephiles" },
				{ message: "Shop & bazaar fill max take into count user's money", contributor: "Mephiles" },
	...
	},
	{
		...
		logs: {
			features: [
				{ message: "Added Notes section to Navigation bar", contributor: "Mephiles" },
				{ message: "Added Fill Max button to city shops & bazaars", contributor: "Mephiles" },
			...
			fixes: [
				...
				{ message: "Fixed double notifications for some messages & events", contributor: "Mephiles" },
				{ message: "Fixed container collapse bubbling when loading site (changes are set before loading the container)", contributor: "Mephiles" },
				{ message: "Fixed Museum set message disappearing because of Upgrade button hide script", contributor: "Mephiles" },
				{ message: "Fixed ERROR badge flashing for some users", contributor: "Mephiles" },
			...
			"thanks - rockyroxanne [2282703]": [
				...
				{ message: "Added option to Align Torn to left", contributor: "Mephiles" },
	...
	},
	{
		...
		logs: {
			features: [
				{ message: "Added option to force TornTools over DoctorN where possible", contributor: "Mephiles" },
				{ message: "Added custom Links to navigation panel", contributor: "Mephiles" },
				{ message: "Added Item Stock into Travel Destinations table (replaced flight time)", contributor: "Powered by YATA" },
				{ message: "Added option to collapse TornTools containers (clicking on the heading works too)", contributor: "Mephiles" },
				{ message: "Added option to show user's status indicator next to their name (page heading)", contributor: "Mephiles" },
				{ message: "Added Stocks price notifications (can set under stocks tab)", contributor: "Mephiles" },
			...
			changes: [
				...
				{ message: "Simplified container headings (removed TornTools text)", contributor: "Mephiles" },
	...
	},
	{
		...
		logs: {
			features: [
				{ message: "Added an Alternative Theme option (black background and green text)", contributor: "Mephiles" },
	...
	},
	{
		...
		logs: {
			features: [
				{ message: "Added a Travel Destinations table to Travel Agency page", contributor: "Mephiles" },
				{
					message:
	...
	},
	{
		...
		logs: {
			features: [
				{ message: "Added new logo", contributor: "Mephiles" },
				{ message: "Added Target List to Settings page", contributor: "Mephiles" },
				{ message: "Added Blackjack and HiLo helpers to Casino", contributor: "Mephiles" },
				{ message: "Added option to disable update notifications", contributor: "Mephiles" },
				{ message: "Added option to disable Gym train buttons", contributor: "Mephiles" },
			...
			changes: [
				...
				{ message: "Improved Missions Reward design", contributor: "Mephiles" },
...
// 			"Added education award tracker. Moved dump and bounty award trackers. - wootty2000 ",
// 		],
// 	},
