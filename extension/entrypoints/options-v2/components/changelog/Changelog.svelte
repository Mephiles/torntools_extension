<script lang="ts">
	...
	import ChangelogSection from "@/entrypoints/options-v2/components/changelog/ChangelogSection.svelte";
	import ContributorList from "@/entrypoints/options-v2/components/changelog/ContributorList.svelte";
	import { ttStorage } from "@/utils/common/data/storage";
	import { readableChangelog, toDisplayableChangelogEntry } from "@/utils/common/functions/changelog";
