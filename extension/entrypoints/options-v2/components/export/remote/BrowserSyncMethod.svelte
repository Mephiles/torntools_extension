<script lang="ts">
	...
	import ExportMethod from "@/entrypoints/options-v2/components/export/ExportMethod.svelte";
	import { importExportData } from "@/entrypoints/options-v2/components/export/export-data";
	import ClearRemoteStorageDialog
		from "@/entrypoints/options-v2/components/export/remote/ClearBrowserSyncDialog.svelte";
	import RemoteSyncInformation from "@/entrypoints/options-v2/components/export/remote/RemoteSyncInformation.svelte";
	import {
		clearRemoteSyncData,
		getByteLength,
		loadRemoteSyncData,
