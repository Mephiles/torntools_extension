<script lang="ts">
	...
	import BenefitInformation from "@/entrypoints/popup/components/stocks/BenefitInformation.svelte";
	import StockSection from "@/entrypoints/popup/components/stocks/StockSection.svelte";
	import type {DatabaseSettings, DatabaseStockdata, DatabaseUserdata} from "@/utils/common/data/database";
	import { ttStorage } from "@/utils/common/data/storage";
	import type {TornV1Stock} from "@/utils/common/functions/api-v1.types";
	import { applyPlural, dropDecimals, formatNumber } from "@/utils/common/functions/formatting";
	import { getStockBoughtPrice } from "@/utils/common/functions/torn";
	import { settingsStore, stockdataStore, userdataStore } from "../../stores/database-store.svelte.js";
