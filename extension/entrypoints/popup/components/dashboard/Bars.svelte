<script lang="ts">
	...
	import { settingsStore, userdataStore } from "@/entrypoints/popup/stores/database-store.svelte";
	import type { DatabaseSettings, DatabaseUserdata } from "@/utils/common/data/database";
	import type { UserV1Bar, UserV1ChainBar } from "@/utils/common/functions/api-v1.types";
	import { formatTime, toSeconds } from "@/utils/common/functions/formatting";
	import {getNextChainBonus, LINKS} from "@/utils/common/functions/torn";
