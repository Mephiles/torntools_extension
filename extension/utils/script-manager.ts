...
import { runGlobalPageScripts } from "@/utils/pages/global-page";
...
import { setupTravelAbroadPage } from "@/utils/pages/travel-abroad-page";
...
import { setupItemPage } from "@/utils/pages/item-page";
import QuickItemsFeature from "@features/quick-items/quick-items";
import CreatorsFeature from "@features/creators/creators";
import { setupAuctionHousePage } from "@/utils/pages/auction-house-page";
import { setupBountiesPage } from "@/utils/pages/bounties-page";
import { setupCrimesV2Page } from "@/utils/pages/crimes2-page";
import { setupCompanyPage } from "@/utils/pages/company-page";
import { setupCrimesV1Page } from "@/utils/pages/crimes1-page";
import { setupFactionsPage } from "@/utils/pages/factions-page";
import { setupGymPage } from "@/utils/pages/gym-page";
import { setupHospitalPage } from "@/utils/pages/hospital-page";
import { setupItemMarketPage } from "@/utils/pages/itemmarket-page";
import { setupJailPage } from "@/utils/pages/jail-page";
import { setupMissionsPage } from "@/utils/pages/missions-page";
import { setupTradePage } from "@/utils/pages/trade-page";
import { setupTravelHomePage } from "@/utils/pages/travel-home-page";
import { setupUserlistPage } from "@/utils/pages/userlist-page";
