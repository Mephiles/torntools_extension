...
export interface YATAFactionMembers {
	members: {
		[id: string]: {
			id: number;
			name: string;
...
export interface YATASpyResponse {
	spies: {
		[id: string]: {
...
export interface YATATravelResponse {
	stocks: {
		[country: string]: {
			update: number;
			stocks: {
...
export interface TornstatsError {
	status: false;
	message: string;
}

export interface TornstatsLoot {
	[id: string]: {
		name: string;
		torn_id: number;
		status: string;
...
export type TornstatsFactionCrimes =
	| {
			status: true;
			message: string;
			members: {
...
export type TornstatsFactionSpyResponse =
	| {
			status: true;
			message: string;
			faction: {
