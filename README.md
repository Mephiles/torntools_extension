...
[![GitHub Release Date](https://img.shields.io/static/v1?label=RELEASE%20DATE&message=February%2C%2011th.%202025&color=%23acea00&style=for-the-badge)](https://github.com/Mephiles/torntools_extension/releases/latest)<!---A pointer for bash-->
...
[![GitHub Build](https://img.shields.io/github/actions/workflow/status/Mephiles/torntools_extension/run-prettier.yml?branch=master&style=for-the-badge&logo=data:image/png;base64,)](https://github.com/Mephiles/torntools_extension/actions/workflows/run-prettier.yml)
...
If you want to submit Pull Requests then we are happy to accept any improvements/additions. You can always contact us
via Discord, Github Issues, or any other platform about changes you'd like to apply so everybody's on the same page.
